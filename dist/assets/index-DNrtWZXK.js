...
* @license MIT
**//*! #__NO_SIDE_EFFECTS__ */function Br(t,e){const n=new Set(t.split(","));return s=>n.has(s)}const J={},rn=[],xe=()=>{},cf=()=>!1,ei=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&(t.charCodeAt(2)>122||t.charCodeAt(2)<97),$r=t=>t.startsWith("onUpdate:"),he=Object.assign,Hr=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},uf=Object.prototype.hasOwnProperty,U=(t,e)=>uf.call(t,e),O=Array.isArray,on=t=>ti(t)==="[object Map]",ja=t=>ti(t)==="[object Set]",D=t=>typeof t=="function",oe=t=>typeof t=="string",qt=t=>typeof t=="symbol",ee=t=>t!==null&&typeof t=="object",Ga=t=>(ee(t)||D(t))&&D(t.then)&&D(t.catch),Ka=Object.prototype.toString,ti=t=>Ka.call(t),hf=t=>ti(t).slice(8,-1),qa=t=>ti(t)==="[object Object]",Vr=t=>oe(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Pn=Br(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),ni=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},ff=/-(\w)/g,hn=ni(t=>t.replace(ff,(e,n)=>n?n.toUpperCase():"")),df=/\B([A-Z])/g,zt=ni(t=>t.replace(df,"-$1").toLowerCase()),za=ni(t=>t.charAt(0).toUpperCase()+t.slice(1)),Pi=ni(t=>t?`on${za(t)}`:""),mt=(t,e)=>!Object.is(t,e),Ss=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},Ya=(t,e,n,s=!1)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,writable:s,value:n})},or=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let tl;const Qa=()=>tl||(tl=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function si(t){if(O(t)){const e={};for(let n=0;n<t.length;n++){const s=t[n],i=oe(s)?mf(s):si(s);if(i)for(const r in i)e[r]=i[r]}return e}else if(oe(t)||ee(t))return t}const pf=/;(?![^(]*\))/g,_f=/:([^]+)/,gf=/\/\*[^]*?\*\//g;function mf(t){const e={};return t.replace(gf,"").split(pf).forEach(n=>{if(n){const s=n.split(_f);s.length>1&&(e[s[0].trim()]=s[1].trim())}}),e}function ii(t){let e="";if(oe(t))e=t;else if(O(t))for(let n=0;n<t.length;n++){const s=ii(t[n]);s&&(e+=s+" ")}else if(ee(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const yf="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",vf=Br(yf);function Ja(t){return!!t||t===""}const Di=t=>oe(t)?t:t==null?"":O(t)||ee(t)&&(t.toString===Ka||!D(t.toString))?JSON.stringify(t,Xa,2):String(t),Xa=(t,e)=>e&&e.__v_isRef?Xa(t,e.value):on(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[s,i],r)=>(n[Mi(s,r)+" =>"]=i,n),{})}:ja(e)?{[`Set(${e.size})`]:[...e.values()].map(n=>Mi(n))}:qt(e)?Mi(e):ee(e)&&!O(e)&&!qa(e)?String(e):e,Mi=(t,e="")=>{var n;return qt(t)?`Symbol(${(n=t.description)!=null?n:e})`:t};/**
* @vue/reactivity v3.4.26
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let De;class Za{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this.parent=De,!e&&De&&(this.index=(De.scopes||(De.scopes=[])).push(this)-1)}get active(){return this._active}run(e){if(this._active){const n=De;try{return De=this,e()}finally{De=n}}}on(){De=this}off(){De=this.parent}stop(e){if(this._active){let n,s;for(n=0,s=this.effects.length;n<s;n++)this.effects[n].stop();for(n=0,s=this.cleanups.length;n<s;n++)this.cleanups[n]();if(this.scopes)for(n=0,s=this.scopes.length;n<s;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0,this._active=!1}}}function bf(t){return new Za(t)}function Cf(t,e=De){e&&e.active&&e.effects.push(t)}function wf(){return De}let Ut;class Wr{constructor(e,n,s,i){this.fn=e,this.trigger=n,this.scheduler=s,this.active=!0,this.deps=[],this._dirtyLevel=4,this._trackId=0,this._runnings=0,this._shouldSchedule=!1,this._depsLength=0,Cf(this,i)}get dirty(){if(this._dirtyLevel===2||this._dirtyLevel===3){this._dirtyLevel=1,wt();for(let e=0;e<this._depsLength;e++){const n=this.deps[e];if(n.computed&&(Ef(n.computed),this._dirtyLevel>=4))break}this._dirtyLevel===1&&(this._dirtyLevel=0),Et()}return this._dirtyLevel>=4}set dirty(e){this._dirtyLevel=e?4:0}run(){if(this._dirtyLevel=0,!this.active)return this.fn();let e=ht,n=Ut;try{return ht=!0,Ut=this,this._runnings++,nl(this),this.fn()}finally{sl(this),this._runnings--,Ut=n,ht=e}}stop(){this.active&&(nl(this),sl(this),this.onStop&&this.onStop(),this.active=!1)}}function Ef(t){return t.value}function nl(t){t._trackId++,t._depsLength=0}function sl(t){if(t.deps.length>t._depsLength){for(let e=t._depsLength;e<t.deps.length;e++)ec(t.deps[e],t);t.deps.length=t._depsLength}}function ec(t,e){const n=t.get(e);n!==void 0&&e._trackId!==n&&(t.delete(e),t.size===0&&t.cleanup())}let ht=!0,lr=0;const tc=[];function wt(){tc.push(ht),ht=!1}function Et(){const t=tc.pop();ht=t===void 0?!0:t}function jr(){lr++}function Gr(){for(lr--;!lr&&ar.length;)ar.shift()()}function nc(t,e,n){if(e.get(t)!==t._trackId){e.set(t,t._trackId);const s=t.deps[t._depsLength];s!==e?(s&&ec(s,t),t.deps[t._depsLength++]=e):t._depsLength++}}const ar=[];function sc(t,e,n){jr();for(const s of t.keys()){let i;s._dirtyLevel<e&&(i??(i=t.get(s)===s._trackId))&&(s._shouldSchedule||(s._shouldSchedule=s._dirtyLevel===0),s._dirtyLevel=e),s._shouldSchedule&&(i??(i=t.get(s)===s._trackId))&&(s.trigger(),(!s._runnings||s.allowRecurse)&&s._dirtyLevel!==2&&(s._shouldSchedule=!1,s.scheduler&&ar.push(s.scheduler)))}Gr()}const ic=(t,e)=>{const n=new Map;return n.cleanup=t,n.computed=e,n},cr=new WeakMap,Bt=Symbol(""),ur=Symbol("");function Ee(t,e,n){if(ht&&Ut){let s=cr.get(t);s||cr.set(t,s=new Map);let i=s.get(n);i||s.set(n,i=ic(()=>s.delete(n))),nc(Ut,i)}}function Ze(t,e,n,s,i,r){const o=cr.get(t);if(!o)return;let l=[];if(e==="clear")l=[...o.values()];else if(n==="length"&&O(t)){const a=Number(s);o.forEach((c,u)=>{(u==="length"||!qt(u)&&u>=a)&&l.push(c)})}else switch(n!==void 0&&l.push(o.get(n)),e){case"add":O(t)?Vr(n)&&l.push(o.get("length")):(l.push(o.get(Bt)),on(t)&&l.push(o.get(ur)));break;case"delete":O(t)||(l.push(o.get(Bt)),on(t)&&l.push(o.get(ur)));break;case"set":on(t)&&l.push(o.get(Bt));break}jr();for(const a of l)a&&sc(a,4);Gr()}const If=Br("__proto__,__v_isRef,__isVue"),rc=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(qt)),il=Sf();function Sf(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const s=W(this);for(let r=0,o=this.length;r<o;r++)Ee(s,"get",r+"");const i=s[e](...n);return i===-1||i===!1?s[e](...n.map(W)):i}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){wt(),jr();const s=W(this)[e].apply(this,n);return Gr(),Et(),s}}),t}function Tf(t){qt(t)||(t=String(t));const e=W(this);return Ee(e,"has",t),e.hasOwnProperty(t)}class oc{constructor(e=!1,n=!1){this._isReadonly=e,this._isShallow=n}get(e,n,s){const i=this._isReadonly,r=this._isShallow;if(n==="__v_isReactive")return!i;if(n==="__v_isReadonly")return i;if(n==="__v_isShallow")return r;if(n==="__v_raw")return s===(i?r?Bf:uc:r?cc:ac).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(s)?e:void 0;const o=O(e);if(!i){if(o&&U(il,n))return Reflect.get(il,n,s);if(n==="hasOwnProperty")return Tf}const l=Reflect.get(e,n,s);return(qt(n)?rc.has(n):If(n))||(i||Ee(e,"get",n),r)?l:pe(l)?o&&Vr(n)?l:l.value:ee(l)?i?hc(l):oi(l):l}}class lc extends oc{constructor(e=!1){super(!1,e)}set(e,n,s,i){let r=e[n];if(!this._isShallow){const a=Wn(r);if(!Ps(s)&&!Wn(s)&&(r=W(r),s=W(s)),!O(e)&&pe(r)&&!pe(s))return a?!1:(r.value=s,!0)}const o=O(e)&&Vr(n)?Number(n)<e.length:U(e,n),l=Reflect.set(e,n,s,i);return e===W(i)&&(o?mt(s,r)&&Ze(e,"set",n,s):Ze(e,"add",n,s)),l}deleteProperty(e,n){const s=U(e,n);e[n];const i=Reflect.deleteProperty(e,n);return i&&s&&Ze(e,"delete",n,void 0),i}has(e,n){const s=Reflect.has(e,n);return(!qt(n)||!rc.has(n))&&Ee(e,"has",n),s}ownKeys(e){return Ee(e,"iterate",O(e)?"length":Bt),Reflect.ownKeys(e)}}class Rf extends oc{constructor(e=!1){super(!0,e)}set(e,n){return!0}deleteProperty(e,n){return!0}}const Af=new lc,Nf=new Rf,xf=new lc(!0);const Kr=t=>t,ri=t=>Reflect.getPrototypeOf(t);function ms(t,e,n=!1,s=!1){t=t.__v_raw;const i=W(t),r=W(e);n||(mt(e,r)&&Ee(i,"get",e),Ee(i,"get",r));const{has:o}=ri(i),l=s?Kr:n?Yr:jn;if(o.call(i,e))return l(t.get(e));if(o.call(i,r))return l(t.get(r));t!==i&&t.get(e)}function ys(t,e=!1){const n=this.__v_raw,s=W(n),i=W(t);return e||(mt(t,i)&&Ee(s,"has",t),Ee(s,"has",i)),t===i?n.has(t):n.has(t)||n.has(i)}function vs(t,e=!1){return t=t.__v_raw,!e&&Ee(W(t),"iterate",Bt),Reflect.get(t,"size",t)}function rl(t){t=W(t);const e=W(this);return ri(e).has.call(e,t)||(e.add(t),Ze(e,"add",t,t)),this}function ol(t,e){e=W(e);const n=W(this),{has:s,get:i}=ri(n);let r=s.call(n,t);r||(t=W(t),r=s.call(n,t));const o=i.call(n,t);return n.set(t,e),r?mt(e,o)&&Ze(n,"set",t,e):Ze(n,"add",t,e),this}function ll(t){const e=W(this),{has:n,get:s}=ri(e);let i=n.call(e,t);i||(t=W(t),i=n.call(e,t)),s&&s.call(e,t);const r=e.delete(t);return i&&Ze(e,"delete",t,void 0),r}function al(){const t=W(this),e=t.size!==0,n=t.clear();return e&&Ze(t,"clear",void 0,void 0),n}function bs(t,e){return function(s,i){const r=this,o=r.__v_raw,l=W(o),a=e?Kr:t?Yr:jn;return!t&&Ee(l,"iterate",Bt),o.forEach((c,u)=>s.call(i,a(c),a(u),r))}}function Cs(t,e,n){return function(...s){const i=this.__v_raw,r=W(i),o=on(r),l=t==="entries"||t===Symbol.iterator&&o,a=t==="keys"&&o,c=i[t](...s),u=n?Kr:e?Yr:jn;return!e&&Ee(r,"iterate",a?ur:Bt),{next(){const{value:h,done:d}=c.next();return d?{value:h,done:d}:{value:l?[u(h[0]),u(h[1])]:u(h),done:d}},[Symbol.iterator](){return this}}}}function ot(t){return function(...e){return t==="delete"?!1:t==="clear"?void 0:this}}function Of(){const t={get(r){return ms(this,r)},get size(){return vs(this)},has:ys,add:rl,set:ol,delete:ll,clear:al,forEach:bs(!1,!1)},e={get(r){return ms(this,r,!1,!0)},get size(){return vs(this)},has:ys,add:rl,set:ol,delete:ll,clear:al,forEach:bs(!1,!0)},n={get(r){return ms(this,r,!0)},get size(){return vs(this,!0)},has(r){return ys.call(this,r,!0)},add:ot("add"),set:ot("set"),delete:ot("delete"),clear:ot("clear"),forEach:bs(!0,!1)},s={get(r){return ms(this,r,!0,!0)},get size(){return vs(this,!0)},has(r){return ys.call(this,r,!0)},add:ot("add"),set:ot("set"),delete:ot("delete"),clear:ot("clear"),forEach:bs(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=Cs(r,!1,!1),n[r]=Cs(r,!0,!1),e[r]=Cs(r,!1,!0),s[r]=Cs(r,!0,!0)}),[t,n,e,s]}const[Pf,Df,Mf,kf]=Of();function qr(t,e){const n=e?t?kf:Mf:t?Df:Pf;return(s,i,r)=>i==="__v_isReactive"?!t:i==="__v_isReadonly"?t:i==="__v_raw"?s:Reflect.get(U(n,i)&&i in s?n:s,i,r)}const Lf={get:qr(!1,!1)},Ff={get:qr(!1,!0)},Uf={get:qr(!0,!1)};const ac=new WeakMap,cc=new WeakMap,uc=new WeakMap,Bf=new WeakMap;function $f(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Hf(t){return t.__v_skip||!Object.isExtensible(t)?0:$f(hf(t))}function oi(t){return Wn(t)?t:zr(t,!1,Af,Lf,ac)}function Vf(t){return zr(t,!1,xf,Ff,cc)}function hc(t){return zr(t,!0,Nf,Uf,uc)}function zr(t,e,n,s,i){if(!ee(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const r=i.get(t);if(r)return r;const o=Hf(t);if(o===0)return t;const l=new Proxy(t,o===2?s:n);return i.set(t,l),l}function Dn(t){return Wn(t)?Dn(t.__v_raw):!!(t&&t.__v_isReactive)}function Wn(t){return!!(t&&t.__v_isReadonly)}function Ps(t){return!!(t&&t.__v_isShallow)}function fc(t){return t?!!t.__v_raw:!1}function W(t){const e=t&&t.__v_raw;return e?W(e):t}function Wf(t){return Object.isExtensible(t)&&Ya(t,"__v_skip",!0),t}const jn=t=>ee(t)?oi(t):t,Yr=t=>ee(t)?hc(t):t;class dc{constructor(e,n,s,i){this.getter=e,this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this.effect=new Wr(()=>e(this._value),()=>Ts(this,this.effect._dirtyLevel===2?2:3)),this.effect.computed=this,this.effect.active=this._cacheable=!i,this.__v_isReadonly=s}get value(){const e=W(this);return(!e._cacheable||e.effect.dirty)&&mt(e._value,e._value=e.effect.run())&&Ts(e,4),pc(e),e.effect._dirtyLevel>=2&&Ts(e,2),e._value}set value(e){this._setter(e)}get _dirty(){return this.effect.dirty}set _dirty(e){this.effect.dirty=e}}function jf(t,e,n=!1){let s,i;const r=D(t);return r?(s=t,i=xe):(s=t.get,i=t.set),new dc(s,i,r||!i,n)}function pc(t){var e;ht&&Ut&&(t=W(t),nc(Ut,(e=t.dep)!=null?e:t.dep=ic(()=>t.dep=void 0,t instanceof dc?t:void 0)))}function Ts(t,e=4,n){t=W(t);const s=t.dep;s&&sc(s,e)}function pe(t){return!!(t&&t.__v_isRef===!0)}function Sn(t){return Gf(t,!1)}function Gf(t,e){return pe(t)?t:new Kf(t,e)}class Kf{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:W(e),this._value=n?e:jn(e)}get value(){return pc(this),this._value}set value(e){const n=this.__v_isShallow||Ps(e)||Wn(e);e=n?e:W(e),mt(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:jn(e),Ts(this,4))}}function xt(t){return pe(t)?t.value:t}const qf={get:(t,e,n)=>xt(Reflect.get(t,e,n)),set:(t,e,n,s)=>{const i=t[e];return pe(i)&&!pe(n)?(i.value=n,!0):Reflect.set(t,e,n,s)}};function _c(t){return Dn(t)?t:new Proxy(t,qf)}/**
* @vue/runtime-core v3.4.26
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function ft(t,e,n,s){try{return s?t(...s):t()}catch(i){li(i,e,n)}}function Ue(t,e,n,s){if(D(t)){const i=ft(t,e,n,s);return i&&Ga(i)&&i.catch(r=>{li(r,e,n)}),i}if(O(t)){const i=[];for(let r=0;r<t.length;r++)i.push(Ue(t[r],e,n,s));return i}}function li(t,e,n,s=!0){const i=e?e.vnode:null;if(e){let r=e.parent;const o=e.proxy,l=`https://vuejs.org/error-reference/#runtime-${n}`;for(;r;){const c=r.ec;if(c){for(let u=0;u<c.length;u++)if(c[u](t,o,l)===!1)return}r=r.parent}const a=e.appContext.config.errorHandler;if(a){wt(),ft(a,null,10,[t,o,l]),Et();return}}zf(t,n,i,s)}function zf(t,e,n,s=!0){console.error(t)}let Gn=!1,hr=!1;const de=[];let qe=0;const ln=[];let at=null,Dt=0;const gc=Promise.resolve();let Qr=null;function Yf(t){const e=Qr||gc;return t?e.then(this?t.bind(this):t):e}function Qf(t){let e=qe+1,n=de.length;for(;e<n;){const s=e+n>>>1,i=de[s],r=Kn(i);r<t||r===t&&i.pre?e=s+1:n=s}return e}function Jr(t){(!de.length||!de.includes(t,Gn&&t.allowRecurse?qe+1:qe))&&(t.id==null?de.push(t):de.splice(Qf(t.id),0,t),mc())}function mc(){!Gn&&!hr&&(hr=!0,Qr=gc.then(vc))}function Jf(t){const e=de.indexOf(t);e>qe&&de.splice(e,1)}function Xf(t){O(t)?ln.push(...t):(!at||!at.includes(t,t.allowRecurse?Dt+1:Dt))&&ln.push(t),mc()}function cl(t,e,n=Gn?qe+1:0){for(;n<de.length;n++){const s=de[n];if(s&&s.pre){if(t&&s.id!==t.uid)continue;de.splice(n,1),n--,s()}}}function yc(t){if(ln.length){const e=[...new Set(ln)].sort((n,s)=>Kn(n)-Kn(s));if(ln.length=0,at){at.push(...e);return}for(at=e,Dt=0;Dt<at.length;Dt++)at[Dt]();at=null,Dt=0}}const Kn=t=>t.id==null?1/0:t.id,Zf=(t,e)=>{const n=Kn(t)-Kn(e);if(n===0){if(t.pre&&!e.pre)return-1;if(e.pre&&!t.pre)return 1}return n};function vc(t){hr=!1,Gn=!0,de.sort(Zf);try{for(qe=0;qe<de.length;qe++){const e=de[qe];e&&e.active!==!1&&ft(e,null,14)}}finally{qe=0,de.length=0,yc(),Gn=!1,Qr=null,(de.length||ln.length)&&vc()}}function ed(t,e,...n){if(t.isUnmounted)return;const s=t.vnode.props||J;let i=n;const r=e.startsWith("update:"),o=r&&e.slice(7);if(o&&o in s){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:h,trim:d}=s[u]||J;d&&(i=n.map(_=>oe(_)?_.trim():_)),h&&(i=n.map(or))}let l,a=s[l=Pi(e)]||s[l=Pi(hn(e))];!a&&r&&(a=s[l=Pi(zt(e))]),a&&Ue(a,t,6,i);const c=s[l+"Once"];if(c){if(!t.emitted)t.emitted={};else if(t.emitted[l])return;t.emitted[l]=!0,Ue(c,t,6,i)}}function bc(t,e,n=!1){const s=e.emitsCache,i=s.get(t);if(i!==void 0)return i;const r=t.emits;let o={},l=!1;if(!D(t)){const a=c=>{const u=bc(c,e,!0);u&&(l=!0,he(o,u))};!n&&e.mixins.length&&e.mixins.forEach(a),t.extends&&a(t.extends),t.mixins&&t.mixins.forEach(a)}return!r&&!l?(ee(t)&&s.set(t,null),null):(O(r)?r.forEach(a=>o[a]=null):he(o,r),ee(t)&&s.set(t,o),o)}function ai(t,e){return!t||!ei(e)?!1:(e=e.slice(2).replace(/Once$/,""),U(t,e[0].toLowerCase()+e.slice(1))||U(t,zt(e))||U(t,e))}let Re=null,Cc=null;function Ds(t){const e=Re;return Re=t,Cc=t&&t.type.__scopeId||null,e}function td(t,e=Re,n){if(!e||t._n)return t;const s=(...i)=>{s._d&&bl(-1);const r=Ds(e);let o;try{o=t(...i)}finally{Ds(r),s._d&&bl(1)}return o};return s._n=!0,s._c=!0,s._d=!0,s}function ki(t){const{type:e,vnode:n,proxy:s,withProxy:i,propsOptions:[r],slots:o,attrs:l,emit:a,render:c,renderCache:u,props:h,data:d,setupState:_,ctx:I,inheritAttrs:R}=t,H=Ds(t);let Y,ne;try{if(n.shapeFlag&4){const se=i||s,Ae=se;Y=Ke(c.call(Ae,se,u,h,_,d,I)),ne=l}else{const se=e;Y=Ke(se.length>1?se(h,{attrs:l,slots:o,emit:a}):se(h,null)),ne=e.props?l:nd(l)}}catch(se){Ln.length=0,li(se,t,1),Y=$t(qn)}let V=Y;if(ne&&R!==!1){const se=Object.keys(ne),{shapeFlag:Ae}=V;se.length&&Ae&7&&(r&&se.some($r)&&(ne=sd(ne,r)),V=fn(V,ne,!1,!0))}return n.dirs&&(V=fn(V,null,!1,!0),V.dirs=V.dirs?V.dirs.concat(n.dirs):n.dirs),n.transition&&(V.transition=n.transition),Y=V,Ds(H),Y}const nd=t=>{let e;for(const n in t)(n==="class"||n==="style"||ei(n))&&((e||(e={}))[n]=t[n]);return e},sd=(t,e)=>{const n={};for(const s in t)(!$r(s)||!(s.slice(9)in e))&&(n[s]=t[s]);return n};function id(t,e,n){const{props:s,children:i,component:r}=t,{props:o,children:l,patchFlag:a}=e,c=r.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&a>=0){if(a&1024)return!0;if(a&16)return s?ul(s,o,c):!!o;if(a&8){const u=e.dynamicProps;for(let h=0;h<u.length;h++){const d=u[h];if(o[d]!==s[d]&&!ai(c,d))return!0}}}else return(i||l)&&(!l||!l.$stable)?!0:s===o?!1:s?o?ul(s,o,c):!0:!!o;return!1}function ul(t,e,n){const s=Object.keys(e);if(s.length!==Object.keys(t).length)return!0;for(let i=0;i<s.length;i++){const r=s[i];if(e[r]!==t[r]&&!ai(n,r))return!0}return!1}function rd({vnode:t,parent:e},n){for(;e;){const s=e.subTree;if(s.suspense&&s.suspense.activeBranch===t&&(s.el=t.el),s===t)(t=e.vnode).el=n,e=e.parent;else break}}const od=Symbol.for("v-ndc"),ld=t=>t.__isSuspense;function ad(t,e){e&&e.pendingBranch?O(t)?e.effects.push(...t):e.effects.push(t):Xf(t)}const cd=Symbol.for("v-scx"),ud=()=>As(cd),ws={};function an(t,e,n){return wc(t,e,n)}function wc(t,e,{immediate:n,deep:s,flush:i,once:r,onTrack:o,onTrigger:l}=J){if(e&&r){const $=e;e=(...Qe)=>{$(...Qe),Ae()}}const a=me,c=$=>s===!0?$:Mt($,s===!1?1:void 0);let u,h=!1,d=!1;if(pe(t)?(u=()=>t.value,h=Ps(t)):Dn(t)?(u=()=>c(t),h=!0):O(t)?(d=!0,h=t.some($=>Dn($)||Ps($)),u=()=>t.map($=>{if(pe($))return $.value;if(Dn($))return c($);if(D($))return ft($,a,2)})):D(t)?e?u=()=>ft(t,a,2):u=()=>(_&&_(),Ue(t,a,3,[I])):u=xe,e&&s){const $=u;u=()=>Mt($())}let _,I=$=>{_=V.onStop=()=>{ft($,a,4),_=V.onStop=void 0}},R;if(hi)if(I=xe,e?n&&Ue(e,a,3,[u(),d?[]:void 0,I]):u(),i==="sync"){const $=ud();R=$.__watcherHandles||($.__watcherHandles=[])}else return xe;let H=d?new Array(t.length).fill(ws):ws;const Y=()=>{if(!(!V.active||!V.dirty))if(e){const $=V.run();(s||h||(d?$.some((Qe,He)=>mt(Qe,H[He])):mt($,H)))&&(_&&_(),Ue(e,a,3,[$,H===ws?void 0:d&&H[0]===ws?[]:H,I]),H=$)}else V.run()};Y.allowRecurse=!!e;let ne;i==="sync"?ne=Y:i==="post"?ne=()=>ve(Y,a&&a.suspense):(Y.pre=!0,a&&(Y.id=a.uid),ne=()=>Jr(Y));const V=new Wr(u,xe,ne),se=wf(),Ae=()=>{V.stop(),se&&Hr(se.effects,V)};return e?n?Y():H=V.run():i==="post"?ve(V.run.bind(V),a&&a.suspense):V.run(),R&&R.push(Ae),Ae}function hd(t,e,n){const s=this.proxy,i=oe(t)?t.includes(".")?Ec(s,t):()=>s[t]:t.bind(s,s);let r;D(e)?r=e:(r=e.handler,n=e);const o=os(this),l=wc(i,r.bind(s),n);return o(),l}function Ec(t,e){const n=e.split(".");return()=>{let s=t;for(let i=0;i<n.length&&s;i++)s=s[n[i]];return s}}function Mt(t,e=1/0,n){if(e<=0||!ee(t)||t.__v_skip||(n=n||new Set,n.has(t)))return t;if(n.add(t),e--,pe(t))Mt(t.value,e,n);else if(O(t))for(let s=0;s<t.length;s++)Mt(t[s],e,n);else if(ja(t)||on(t))t.forEach(s=>{Mt(s,e,n)});else if(qa(t))for(const s in t)Mt(t[s],e,n);return t}function hl(t,e){if(Re===null)return t;const n=fi(Re)||Re.proxy,s=t.dirs||(t.dirs=[]);for(let i=0;i<e.length;i++){let[r,o,l,a=J]=e[i];r&&(D(r)&&(r={mounted:r,updated:r}),r.deep&&Mt(o),s.push({dir:r,instance:n,value:o,oldValue:void 0,arg:l,modifiers:a}))}return t}function At(t,e,n,s){const i=t.dirs,r=e&&e.dirs;for(let o=0;o<i.length;o++){const l=i[o];r&&(l.oldValue=r[o].value);let a=l.dir[s];a&&(wt(),Ue(a,n,8,[t.el,l,t,e]),Et())}}const Rs=t=>!!t.type.__asyncLoader,Ic=t=>t.type.__isKeepAlive;function fd(t,e){Sc(t,"a",e)}function dd(t,e){Sc(t,"da",e)}function Sc(t,e,n=me){const s=t.__wdc||(t.__wdc=()=>{let i=n;for(;i;){if(i.isDeactivated)return;i=i.parent}return t()});if(ci(e,s,n),n){let i=n.parent;for(;i&&i.parent;)Ic(i.parent.vnode)&&pd(s,e,n,i),i=i.parent}}function pd(t,e,n,s){const i=ci(e,t,s,!0);Rc(()=>{Hr(s[e],i)},n)}function ci(t,e,n=me,s=!1){if(n){const i=n[t]||(n[t]=[]),r=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;wt();const l=os(n),a=Ue(e,n,t,o);return l(),Et(),a});return s?i.unshift(r):i.push(r),r}}const st=t=>(e,n=me)=>(!hi||t==="sp")&&ci(t,(...s)=>e(...s),n),_d=st("bm"),Tc=st("m"),gd=st("bu"),md=st("u"),yd=st("bum"),Rc=st("um"),vd=st("sp"),bd=st("rtg"),Cd=st("rtc");function wd(t,e=me){ci("ec",t,e)}function Ed(t,e,n,s){let i;const r=n;if(O(t)||oe(t)){i=new Array(t.length);for(let o=0,l=t.length;o<l;o++)i[o]=e(t[o],o,void 0,r)}else if(typeof t=="number"){i=new Array(t);for(let o=0;o<t;o++)i[o]=e(o+1,o,void 0,r)}else if(ee(t))if(t[Symbol.iterator])i=Array.from(t,(o,l)=>e(o,l,void 0,r));else{const o=Object.keys(t);i=new Array(o.length);for(let l=0,a=o.length;l<a;l++){const c=o[l];i[l]=e(t[c],c,l,r)}}else i=[];return i}const fr=t=>t?Vc(t)?fi(t)||t.proxy:fr(t.parent):null,Mn=he(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>fr(t.parent),$root:t=>fr(t.root),$emit:t=>t.emit,$options:t=>Xr(t),$forceUpdate:t=>t.f||(t.f=()=>{t.effect.dirty=!0,Jr(t.update)}),$nextTick:t=>t.n||(t.n=Yf.bind(t.proxy)),$watch:t=>hd.bind(t)}),Li=(t,e)=>t!==J&&!t.__isScriptSetup&&U(t,e),Id={get({_:t},e){if(e==="__v_skip")return!0;const{ctx:n,setupState:s,data:i,props:r,accessCache:o,type:l,appContext:a}=t;let c;if(e[0]!=="$"){const _=o[e];if(_!==void 0)switch(_){case 1:return s[e];case 2:return i[e];case 4:return n[e];case 3:return r[e]}else{if(Li(s,e))return o[e]=1,s[e];if(i!==J&&U(i,e))return o[e]=2,i[e];if((c=t.propsOptions[0])&&U(c,e))return o[e]=3,r[e];if(n!==J&&U(n,e))return o[e]=4,n[e];dr&&(o[e]=0)}}const u=Mn[e];let h,d;if(u)return e==="$attrs"&&Ee(t.attrs,"get",""),u(t);if((h=l.__cssModules)&&(h=h[e]))return h;if(n!==J&&U(n,e))return o[e]=4,n[e];if(d=a.config.globalProperties,U(d,e))return d[e]},set({_:t},e,n){const{data:s,setupState:i,ctx:r}=t;return Li(i,e)?(i[e]=n,!0):s!==J&&U(s,e)?(s[e]=n,!0):U(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(r[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:s,appContext:i,propsOptions:r}},o){let l;return!!n[o]||t!==J&&U(t,o)||Li(e,o)||(l=r[0])&&U(l,o)||U(s,o)||U(Mn,o)||U(i.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:U(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};function fl(t){return O(t)?t.reduce((e,n)=>(e[n]=null,e),{}):t}let dr=!0;function Sd(t){const e=Xr(t),n=t.proxy,s=t.ctx;dr=!1,e.beforeCreate&&dl(e.beforeCreate,t,"bc");const{data:i,computed:r,methods:o,watch:l,provide:a,inject:c,created:u,beforeMount:h,mounted:d,beforeUpdate:_,updated:I,activated:R,deactivated:H,beforeDestroy:Y,beforeUnmount:ne,destroyed:V,unmounted:se,render:Ae,renderTracked:$,renderTriggered:Qe,errorCaptured:He,serverPrefetch:Ni,expose:St,inheritAttrs:wn,components:ds,directives:ps,filters:xi}=e;if(c&&Td(c,s,null),o)for(const Z in o){const K=o[Z];D(K)&&(s[Z]=K.bind(n))}if(i){const Z=i.call(n,n);ee(Z)&&(t.data=oi(Z))}if(dr=!0,r)for(const Z in r){const K=r[Z],Tt=D(K)?K.bind(n,n):D(K.get)?K.get.bind(n,n):xe,_s=!D(K)&&D(K.set)?K.set.bind(n):xe,Rt=jc({get:Tt,set:_s});Object.defineProperty(s,Z,{enumerable:!0,configurable:!0,get:()=>Rt.value,set:Ve=>Rt.value=Ve})}if(l)for(const Z in l)Ac(l[Z],s,n,Z);if(a){const Z=D(a)?a.call(n):a;Reflect.ownKeys(Z).forEach(K=>{Pd(K,Z[K])})}u&&dl(u,t,"c");function _e(Z,K){O(K)?K.forEach(Tt=>Z(Tt.bind(n))):K&&Z(K.bind(n))}if(_e(_d,h),_e(Tc,d),_e(gd,_),_e(md,I),_e(fd,R),_e(dd,H),_e(wd,He),_e(Cd,$),_e(bd,Qe),_e(yd,ne),_e(Rc,se),_e(vd,Ni),O(St))if(St.length){const Z=t.exposed||(t.exposed={});St.forEach(K=>{Object.defineProperty(Z,K,{get:()=>n[K],set:Tt=>n[K]=Tt})})}else t.exposed||(t.exposed={});Ae&&t.render===xe&&(t.render=Ae),wn!=null&&(t.inheritAttrs=wn),ds&&(t.components=ds),ps&&(t.directives=ps)}function Td(t,e,n=xe){O(t)&&(t=pr(t));for(const s in t){const i=t[s];let r;ee(i)?"default"in i?r=As(i.from||s,i.default,!0):r=As(i.from||s):r=As(i),pe(r)?Object.defineProperty(e,s,{enumerable:!0,configurable:!0,get:()=>r.value,set:o=>r.value=o}):e[s]=r}}function dl(t,e,n){Ue(O(t)?t.map(s=>s.bind(e.proxy)):t.bind(e.proxy),e,n)}function Ac(t,e,n,s){const i=s.includes(".")?Ec(n,s):()=>n[s];if(oe(t)){const r=e[t];D(r)&&an(i,r)}else if(D(t))an(i,t.bind(n));else if(ee(t))if(O(t))t.forEach(r=>Ac(r,e,n,s));else{const r=D(t.handler)?t.handler.bind(n):e[t.handler];D(r)&&an(i,r,t)}}function Xr(t){const e=t.type,{mixins:n,extends:s}=e,{mixins:i,optionsCache:r,config:{optionMergeStrategies:o}}=t.appContext,l=r.get(e);let a;return l?a=l:!i.length&&!n&&!s?a=e:(a={},i.length&&i.forEach(c=>Ms(a,c,o,!0)),Ms(a,e,o)),ee(e)&&r.set(e,a),a}function Ms(t,e,n,s=!1){const{mixins:i,extends:r}=e;r&&Ms(t,r,n,!0),i&&i.forEach(o=>Ms(t,o,n,!0));for(const o in e)if(!(s&&o==="expose")){const l=Rd[o]||n&&n[o];t[o]=l?l(t[o],e[o]):e[o]}return t}const Rd={data:pl,props:_l,emits:_l,methods:On,computed:On,beforeCreate:ge,created:ge,beforeMount:ge,mounted:ge,beforeUpdate:ge,updated:ge,beforeDestroy:ge,beforeUnmount:ge,destroyed:ge,unmounted:ge,activated:ge,deactivated:ge,errorCaptured:ge,serverPrefetch:ge,components:On,directives:On,watch:Nd,provide:pl,inject:Ad};function pl(t,e){return e?t?function(){return he(D(t)?t.call(this,this):t,D(e)?e.call(this,this):e)}:e:t}function Ad(t,e){return On(pr(t),pr(e))}function pr(t){if(O(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function ge(t,e){return t?[...new Set([].concat(t,e))]:e}function On(t,e){return t?he(Object.create(null),t,e):e}function _l(t,e){return t?O(t)&&O(e)?[...new Set([...t,...e])]:he(Object.create(null),fl(t),fl(e??{})):e}function Nd(t,e){if(!t)return e;if(!e)return t;const n=he(Object.create(null),t);for(const s in e)n[s]=ge(t[s],e[s]);return n}function Nc(){return{app:null,config:{isNativeTag:cf,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let xd=0;function Od(t,e){return function(s,i=null){D(s)||(s=he({},s)),i!=null&&!ee(i)&&(i=null);const r=Nc(),o=new WeakSet;let l=!1;const a=r.app={_uid:xd++,_component:s,_props:i,_container:null,_context:r,_instance:null,version:sp,get config(){return r.config},set config(c){},use(c,...u){return o.has(c)||(c&&D(c.install)?(o.add(c),c.install(a,...u)):D(c)&&(o.add(c),c(a,...u))),a},mixin(c){return r.mixins.includes(c)||r.mixins.push(c),a},component(c,u){return u?(r.components[c]=u,a):r.components[c]},directive(c,u){return u?(r.directives[c]=u,a):r.directives[c]},mount(c,u,h){if(!l){const d=$t(s,i);return d.appContext=r,h===!0?h="svg":h===!1&&(h=void 0),u&&e?e(d,c):t(d,c,h),l=!0,a._container=c,c.__vue_app__=a,fi(d.component)||d.component.proxy}},unmount(){l&&(t(null,a._container),delete a._container.__vue_app__)},provide(c,u){return r.provides[c]=u,a},runWithContext(c){const u=kn;kn=a;try{return c()}finally{kn=u}}};return a}}let kn=null;function Pd(t,e){if(me){let n=me.provides;const s=me.parent&&me.parent.provides;s===n&&(n=me.provides=Object.create(s)),n[t]=e}}function As(t,e,n=!1){const s=me||Re;if(s||kn){const i=s?s.parent==null?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides:kn._context.provides;if(i&&t in i)return i[t];if(arguments.length>1)return n&&D(e)?e.call(s&&s.proxy):e}}const xc={},Oc=()=>Object.create(xc),Pc=t=>Object.getPrototypeOf(t)===xc;function Dd(t,e,n,s=!1){const i={},r=Oc();t.propsDefaults=Object.create(null),Dc(t,e,i,r);for(const o in t.propsOptions[0])o in i||(i[o]=void 0);n?t.props=s?i:Vf(i):t.type.props?t.props=i:t.props=r,t.attrs=r}function Md(t,e,n,s){const{props:i,attrs:r,vnode:{patchFlag:o}}=t,l=W(i),[a]=t.propsOptions;let c=!1;if((s||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let h=0;h<u.length;h++){let d=u[h];if(ai(t.emitsOptions,d))continue;const _=e[d];if(a)if(U(r,d))_!==r[d]&&(r[d]=_,c=!0);else{const I=hn(d);i[I]=_r(a,l,I,_,t,!1)}else _!==r[d]&&(r[d]=_,c=!0)}}}else{Dc(t,e,i,r)&&(c=!0);let u;for(const h in l)(!e||!U(e,h)&&((u=zt(h))===h||!U(e,u)))&&(a?n&&(n[h]!==void 0||n[u]!==void 0)&&(i[h]=_r(a,l,h,void 0,t,!0)):delete i[h]);if(r!==l)for(const h in r)(!e||!U(e,h))&&(delete r[h],c=!0)}c&&Ze(t.attrs,"set","")}function Dc(t,e,n,s){const[i,r]=t.propsOptions;let o=!1,l;if(e)for(let a in e){if(Pn(a))continue;const c=e[a];let u;i&&U(i,u=hn(a))?!r||!r.includes(u)?n[u]=c:(l||(l={}))[u]=c:ai(t.emitsOptions,a)||(!(a in s)||c!==s[a])&&(s[a]=c,o=!0)}if(r){const a=W(n),c=l||J;for(let u=0;u<r.length;u++){const h=r[u];n[h]=_r(i,a,h,c[h],t,!U(c,h))}}return o}function _r(t,e,n,s,i,r){const o=t[n];if(o!=null){const l=U(o,"default");if(l&&s===void 0){const a=o.default;if(o.type!==Function&&!o.skipFactory&&D(a)){const{propsDefaults:c}=i;if(n in c)s=c[n];else{const u=os(i);s=c[n]=a.call(null,e),u()}}else s=a}o[0]&&(r&&!l?s=!1:o[1]&&(s===""||s===zt(n))&&(s=!0))}return s}function Mc(t,e,n=!1){const s=e.propsCache,i=s.get(t);if(i)return i;const r=t.props,o={},l=[];let a=!1;if(!D(t)){const u=h=>{a=!0;const[d,_]=Mc(h,e,!0);he(o,d),_&&l.push(..._)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!r&&!a)return ee(t)&&s.set(t,rn),rn;if(O(r))for(let u=0;u<r.length;u++){const h=hn(r[u]);gl(h)&&(o[h]=J)}else if(r)for(const u in r){const h=hn(u);if(gl(h)){const d=r[u],_=o[h]=O(d)||D(d)?{type:d}:he({},d);if(_){const I=vl(Boolean,_.type),R=vl(String,_.type);_[0]=I>-1,_[1]=R<0||I<R,(I>-1||U(_,"default"))&&l.push(h)}}}const c=[o,l];return ee(t)&&s.set(t,c),c}function gl(t){return t[0]!=="$"&&!Pn(t)}function ml(t){return t===null?"null":typeof t=="function"?t.name||"":typeof t=="object"&&t.constructor&&t.constructor.name||""}function yl(t,e){return ml(t)===ml(e)}function vl(t,e){return O(e)?e.findIndex(n=>yl(n,t)):D(e)&&yl(e,t)?0:-1}const kc=t=>t[0]==="_"||t==="$stable",Zr=t=>O(t)?t.map(Ke):[Ke(t)],kd=(t,e,n)=>{if(e._n)return e;const s=td((...i)=>Zr(e(...i)),n);return s._c=!1,s},Lc=(t,e,n)=>{const s=t._ctx;for(const i in t){if(kc(i))continue;const r=t[i];if(D(r))e[i]=kd(i,r,s);else if(r!=null){const o=Zr(r);e[i]=()=>o}}},Fc=(t,e)=>{const n=Zr(e);t.slots.default=()=>n},Ld=(t,e)=>{const n=t.slots=Oc();if(t.vnode.shapeFlag&32){const s=e._;s?(he(n,e),Ya(n,"_",s,!0)):Lc(e,n)}else e&&Fc(t,e)},Fd=(t,e,n)=>{const{vnode:s,slots:i}=t;let r=!0,o=J;if(s.shapeFlag&32){const l=e._;l?n&&l===1?r=!1:(he(i,e),!n&&l===1&&delete i._):(r=!e.$stable,Lc(e,i)),o=e}else e&&(Fc(t,e),o={default:1});if(r)for(const l in i)!kc(l)&&o[l]==null&&delete i[l]};function gr(t,e,n,s,i=!1){if(O(t)){t.forEach((d,_)=>gr(d,e&&(O(e)?e[_]:e),n,s,i));return}if(Rs(s)&&!i)return;const r=s.shapeFlag&4?fi(s.component)||s.component.proxy:s.el,o=i?null:r,{i:l,r:a}=t,c=e&&e.r,u=l.refs===J?l.refs={}:l.refs,h=l.setupState;if(c!=null&&c!==a&&(oe(c)?(u[c]=null,U(h,c)&&(h[c]=null)):pe(c)&&(c.value=null)),D(a))ft(a,l,12,[o,u]);else{const d=oe(a),_=pe(a);if(d||_){const I=()=>{if(t.f){const R=d?U(h,a)?h[a]:u[a]:a.value;i?O(R)&&Hr(R,r):O(R)?R.includes(r)||R.push(r):d?(u[a]=[r],U(h,a)&&(h[a]=u[a])):(a.value=[r],t.k&&(u[t.k]=a.value))}else d?(u[a]=o,U(h,a)&&(h[a]=o)):_&&(a.value=o,t.k&&(u[t.k]=o))};o?(I.id=-1,ve(I,n)):I()}}}const ve=ad;function Ud(t){return Bd(t)}function Bd(t,e){const n=Qa();n.__VUE__=!0;const{insert:s,remove:i,patchProp:r,createElement:o,createText:l,createComment:a,setText:c,setElementText:u,parentNode:h,nextSibling:d,setScopeId:_=xe,insertStaticContent:I}=t,R=(f,p,g,m=null,y=null,w=null,S=void 0,C=null,E=!!p.dynamicChildren)=>{if(f===p)return;f&&!Tn(f,p)&&(m=gs(f),Ve(f,y,w,!0),f=null),p.patchFlag===-2&&(E=!1,p.dynamicChildren=null);const{type:v,ref:T,shapeFlag:N}=p;switch(v){case ui:H(f,p,g,m);break;case qn:Y(f,p,g,m);break;case Ui:f==null&&ne(p,g,m,S);break;case Ge:ds(f,p,g,m,y,w,S,C,E);break;default:N&1?Ae(f,p,g,m,y,w,S,C,E):N&6?ps(f,p,g,m,y,w,S,C,E):(N&64||N&128)&&v.process(f,p,g,m,y,w,S,C,E,En)}T!=null&&y&&gr(T,f&&f.ref,w,p||f,!p)},H=(f,p,g,m)=>{if(f==null)s(p.el=l(p.children),g,m);else{const y=p.el=f.el;p.children!==f.children&&c(y,p.children)}},Y=(f,p,g,m)=>{f==null?s(p.el=a(p.children||""),g,m):p.el=f.el},ne=(f,p,g,m)=>{[f.el,f.anchor]=I(f.children,p,g,m,f.el,f.anchor)},V=({el:f,anchor:p},g,m)=>{let y;for(;f&&f!==p;)y=d(f),s(f,g,m),f=y;s(p,g,m)},se=({el:f,anchor:p})=>{let g;for(;f&&f!==p;)g=d(f),i(f),f=g;i(p)},Ae=(f,p,g,m,y,w,S,C,E)=>{p.type==="svg"?S="svg":p.type==="math"&&(S="mathml"),f==null?$(p,g,m,y,w,S,C,E):Ni(f,p,y,w,S,C,E)},$=(f,p,g,m,y,w,S,C)=>{let E,v;const{props:T,shapeFlag:N,transition:A,dirs:P}=f;if(E=f.el=o(f.type,w,T&&T.is,T),N&8?u(E,f.children):N&16&&He(f.children,E,null,m,y,Fi(f,w),S,C),P&&At(f,null,m,"created"),Qe(E,f,f.scopeId,S,m),T){for(const j in T)j!=="value"&&!Pn(j)&&r(E,j,null,T[j],w,f.children,m,y,Je);"value"in T&&r(E,"value",null,T.value,w),(v=T.onVnodeBeforeMount)&&je(v,m,f)}P&&At(f,null,m,"beforeMount");const F=$d(y,A);F&&A.beforeEnter(E),s(E,p,g),((v=T&&T.onVnodeMounted)||F||P)&&ve(()=>{v&&je(v,m,f),F&&A.enter(E),P&&At(f,null,m,"mounted")},y)},Qe=(f,p,g,m,y)=>{if(g&&_(f,g),m)for(let w=0;w<m.length;w++)_(f,m[w]);if(y){let w=y.subTree;if(p===w){const S=y.vnode;Qe(f,S,S.scopeId,S.slotScopeIds,y.parent)}}},He=(f,p,g,m,y,w,S,C,E=0)=>{for(let v=E;v<f.length;v++){const T=f[v]=C?ct(f[v]):Ke(f[v]);R(null,T,p,g,m,y,w,S,C)}},Ni=(f,p,g,m,y,w,S)=>{const C=p.el=f.el;let{patchFlag:E,dynamicChildren:v,dirs:T}=p;E|=f.patchFlag&16;const N=f.props||J,A=p.props||J;let P;if(g&&Nt(g,!1),(P=A.onVnodeBeforeUpdate)&&je(P,g,p,f),T&&At(p,f,g,"beforeUpdate"),g&&Nt(g,!0),v?St(f.dynamicChildren,v,C,g,m,Fi(p,y),w):S||K(f,p,C,null,g,m,Fi(p,y),w,!1),E>0){if(E&16)wn(C,p,N,A,g,m,y);else if(E&2&&N.class!==A.class&&r(C,"class",null,A.class,y),E&4&&r(C,"style",N.style,A.style,y),E&8){const F=p.dynamicProps;for(let j=0;j<F.length;j++){const X=F[j],le=N[X],Pe=A[X];(Pe!==le||X==="value")&&r(C,X,le,Pe,y,f.children,g,m,Je)}}E&1&&f.children!==p.children&&u(C,p.children)}else!S&&v==null&&wn(C,p,N,A,g,m,y);((P=A.onVnodeUpdated)||T)&&ve(()=>{P&&je(P,g,p,f),T&&At(p,f,g,"updated")},m)},St=(f,p,g,m,y,w,S)=>{for(let C=0;C<p.length;C++){const E=f[C],v=p[C],T=E.el&&(E.type===Ge||!Tn(E,v)||E.shapeFlag&70)?h(E.el):g;R(E,v,T,null,m,y,w,S,!0)}},wn=(f,p,g,m,y,w,S)=>{if(g!==m){if(g!==J)for(const C in g)!Pn(C)&&!(C in m)&&r(f,C,g[C],null,S,p.children,y,w,Je);for(const C in m){if(Pn(C))continue;const E=m[C],v=g[C];E!==v&&C!=="value"&&r(f,C,v,E,S,p.children,y,w,Je)}"value"in m&&r(f,"value",g.value,m.value,S)}},ds=(f,p,g,m,y,w,S,C,E)=>{const v=p.el=f?f.el:l(""),T=p.anchor=f?f.anchor:l("");let{patchFlag:N,dynamicChildren:A,slotScopeIds:P}=p;P&&(C=C?C.concat(P):P),f==null?(s(v,g,m),s(T,g,m),He(p.children||[],g,T,y,w,S,C,E)):N>0&&N&64&&A&&f.dynamicChildren?(St(f.dynamicChildren,A,g,y,w,S,C),(p.key!=null||y&&p===y.subTree)&&Uc(f,p,!0)):K(f,p,g,T,y,w,S,C,E)},ps=(f,p,g,m,y,w,S,C,E)=>{p.slotScopeIds=C,f==null?p.shapeFlag&512?y.ctx.activate(p,g,m,S,E):xi(p,g,m,y,w,S,E):qo(f,p,E)},xi=(f,p,g,m,y,w,S)=>{const C=f.component=Jd(f,m,y);if(Ic(f)&&(C.ctx.renderer=En),Xd(C),C.asyncDep){if(y&&y.registerDep(C,_e),!f.el){const E=C.subTree=$t(qn);Y(null,E,p,g)}}else _e(C,f,p,g,y,w,S)},qo=(f,p,g)=>{const m=p.component=f.component;if(id(f,p,g))if(m.asyncDep&&!m.asyncResolved){Z(m,p,g);return}else m.next=p,Jf(m.update),m.effect.dirty=!0,m.update();else p.el=f.el,m.vnode=p},_e=(f,p,g,m,y,w,S)=>{const C=()=>{if(f.isMounted){let{next:T,bu:N,u:A,parent:P,vnode:F}=f;{const Xt=Bc(f);if(Xt){T&&(T.el=F.el,Z(f,T,S)),Xt.asyncDep.then(()=>{f.isUnmounted||C()});return}}let j=T,X;Nt(f,!1),T?(T.el=F.el,Z(f,T,S)):T=F,N&&Ss(N),(X=T.props&&T.props.onVnodeBeforeUpdate)&&je(X,P,T,F),Nt(f,!0);const le=ki(f),Pe=f.subTree;f.subTree=le,R(Pe,le,h(Pe.el),gs(Pe),f,y,w),T.el=le.el,j===null&&rd(f,le.el),A&&ve(A,y),(X=T.props&&T.props.onVnodeUpdated)&&ve(()=>je(X,P,T,F),y)}else{let T;const{el:N,props:A}=p,{bm:P,m:F,parent:j}=f,X=Rs(p);if(Nt(f,!1),P&&Ss(P),!X&&(T=A&&A.onVnodeBeforeMount)&&je(T,j,p),Nt(f,!0),N&&Jo){const le=()=>{f.subTree=ki(f),Jo(N,f.subTree,f,y,null)};X?p.type.__asyncLoader().then(()=>!f.isUnmounted&&le()):le()}else{const le=f.subTree=ki(f);R(null,le,g,m,f,y,w),p.el=le.el}if(F&&ve(F,y),!X&&(T=A&&A.onVnodeMounted)){const le=p;ve(()=>je(T,j,le),y)}(p.shapeFlag&256||j&&Rs(j.vnode)&&j.vnode.shapeFlag&256)&&f.a&&ve(f.a,y),f.isMounted=!0,p=g=m=null}},E=f.effect=new Wr(C,xe,()=>Jr(v),f.scope),v=f.update=()=>{E.dirty&&E.run()};v.id=f.uid,Nt(f,!0),v()},Z=(f,p,g)=>{p.component=f;const m=f.vnode.props;f.vnode=p,f.next=null,Md(f,p.props,m,g),Fd(f,p.children,g),wt(),cl(f),Et()},K=(f,p,g,m,y,w,S,C,E=!1)=>{const v=f&&f.children,T=f?f.shapeFlag:0,N=p.children,{patchFlag:A,shapeFlag:P}=p;if(A>0){if(A&128){_s(v,N,g,m,y,w,S,C,E);return}else if(A&256){Tt(v,N,g,m,y,w,S,C,E);return}}P&8?(T&16&&Je(v,y,w),N!==v&&u(g,N)):T&16?P&16?_s(v,N,g,m,y,w,S,C,E):Je(v,y,w,!0):(T&8&&u(g,""),P&16&&He(N,g,m,y,w,S,C,E))},Tt=(f,p,g,m,y,w,S,C,E)=>{f=f||rn,p=p||rn;const v=f.length,T=p.length,N=Math.min(v,T);let A;for(A=0;A<N;A++){const P=p[A]=E?ct(p[A]):Ke(p[A]);R(f[A],P,g,null,y,w,S,C,E)}v>T?Je(f,y,w,!0,!1,N):He(p,g,m,y,w,S,C,E,N)},_s=(f,p,g,m,y,w,S,C,E)=>{let v=0;const T=p.length;let N=f.length-1,A=T-1;for(;v<=N&&v<=A;){const P=f[v],F=p[v]=E?ct(p[v]):Ke(p[v]);if(Tn(P,F))R(P,F,g,null,y,w,S,C,E);else break;v++}for(;v<=N&&v<=A;){const P=f[N],F=p[A]=E?ct(p[A]):Ke(p[A]);if(Tn(P,F))R(P,F,g,null,y,w,S,C,E);else break;N--,A--}if(v>N){if(v<=A){const P=A+1,F=P<T?p[P].el:m;for(;v<=A;)R(null,p[v]=E?ct(p[v]):Ke(p[v]),g,F,y,w,S,C,E),v++}}else if(v>A)for(;v<=N;)Ve(f[v],y,w,!0),v++;else{const P=v,F=v,j=new Map;for(v=F;v<=A;v++){const Te=p[v]=E?ct(p[v]):Ke(p[v]);Te.key!=null&&j.set(Te.key,v)}let X,le=0;const Pe=A-F+1;let Xt=!1,Xo=0;const In=new Array(Pe);for(v=0;v<Pe;v++)In[v]=0;for(v=P;v<=N;v++){const Te=f[v];if(le>=Pe){Ve(Te,y,w,!0);continue}let We;if(Te.key!=null)We=j.get(Te.key);else for(X=F;X<=A;X++)if(In[X-F]===0&&Tn(Te,p[X])){We=X;break}We===void 0?Ve(Te,y,w,!0):(In[We-F]=v+1,We>=Xo?Xo=We:Xt=!0,R(Te,p[We],g,null,y,w,S,C,E),le++)}const Zo=Xt?Hd(In):rn;for(X=Zo.length-1,v=Pe-1;v>=0;v--){const Te=F+v,We=p[Te],el=Te+1<T?p[Te+1].el:m;In[v]===0?R(null,We,g,el,y,w,S,C,E):Xt&&(X<0||v!==Zo[X]?Rt(We,g,el,2):X--)}}},Rt=(f,p,g,m,y=null)=>{const{el:w,type:S,transition:C,children:E,shapeFlag:v}=f;if(v&6){Rt(f.component.subTree,p,g,m);return}if(v&128){f.suspense.move(p,g,m);return}if(v&64){S.move(f,p,g,En);return}if(S===Ge){s(w,p,g);for(let N=0;N<E.length;N++)Rt(E[N],p,g,m);s(f.anchor,p,g);return}if(S===Ui){V(f,p,g);return}if(m!==2&&v&1&&C)if(m===0)C.beforeEnter(w),s(w,p,g),ve(()=>C.enter(w),y);else{const{leave:N,delayLeave:A,afterLeave:P}=C,F=()=>s(w,p,g),j=()=>{N(w,()=>{F(),P&&P()})};A?A(w,F,j):j()}else s(w,p,g)},Ve=(f,p,g,m=!1,y=!1)=>{const{type:w,props:S,ref:C,children:E,dynamicChildren:v,shapeFlag:T,patchFlag:N,dirs:A}=f;if(C!=null&&gr(C,null,g,f,!0),T&256){p.ctx.deactivate(f);return}const P=T&1&&A,F=!Rs(f);let j;if(F&&(j=S&&S.onVnodeBeforeUnmount)&&je(j,p,f),T&6)af(f.component,g,m);else{if(T&128){f.suspense.unmount(g,m);return}P&&At(f,null,p,"beforeUnmount"),T&64?f.type.remove(f,p,g,y,En,m):v&&(w!==Ge||N>0&&N&64)?Je(v,p,g,!1,!0):(w===Ge&&N&384||!y&&T&16)&&Je(E,p,g),m&&zo(f)}(F&&(j=S&&S.onVnodeUnmounted)||P)&&ve(()=>{j&&je(j,p,f),P&&At(f,null,p,"unmounted")},g)},zo=f=>{const{type:p,el:g,anchor:m,transition:y}=f;if(p===Ge){lf(g,m);return}if(p===Ui){se(f);return}const w=()=>{i(g),y&&!y.persisted&&y.afterLeave&&y.afterLeave()};if(f.shapeFlag&1&&y&&!y.persisted){const{leave:S,delayLeave:C}=y,E=()=>S(g,w);C?C(f.el,w,E):E()}else w()},lf=(f,p)=>{let g;for(;f!==p;)g=d(f),i(f),f=g;i(p)},af=(f,p,g)=>{const{bum:m,scope:y,update:w,subTree:S,um:C}=f;m&&Ss(m),y.stop(),w&&(w.active=!1,Ve(S,f,p,g)),C&&ve(C,p),ve(()=>{f.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&f.asyncDep&&!f.asyncResolved&&f.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},Je=(f,p,g,m=!1,y=!1,w=0)=>{for(let S=w;S<f.length;S++)Ve(f[S],p,g,m,y)},gs=f=>f.shapeFlag&6?gs(f.component.subTree):f.shapeFlag&128?f.suspense.next():d(f.anchor||f.el);let Oi=!1;const Yo=(f,p,g)=>{f==null?p._vnode&&Ve(p._vnode,null,null,!0):R(p._vnode||null,f,p,null,null,null,g),Oi||(Oi=!0,cl(),yc(),Oi=!1),p._vnode=f},En={p:R,um:Ve,m:Rt,r:zo,mt:xi,mc:He,pc:K,pbc:St,n:gs,o:t};let Qo,Jo;return{render:Yo,hydrate:Qo,createApp:Od(Yo,Qo)}}function Fi({type:t,props:e},n){return n==="svg"&&t==="foreignObject"||n==="mathml"&&t==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:n}function Nt({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function $d(t,e){return(!t||t&&!t.pendingBranch)&&e&&!e.persisted}function Uc(t,e,n=!1){const s=t.children,i=e.children;if(O(s)&&O(i))for(let r=0;r<s.length;r++){const o=s[r];let l=i[r];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=i[r]=ct(i[r]),l.el=o.el),n||Uc(o,l)),l.type===ui&&(l.el=o.el)}}function Hd(t){const e=t.slice(),n=[0];let s,i,r,o,l;const a=t.length;for(s=0;s<a;s++){const c=t[s];if(c!==0){if(i=n[n.length-1],t[i]<c){e[s]=i,n.push(s);continue}for(r=0,o=n.length-1;r<o;)l=r+o>>1,t[n[l]]<c?r=l+1:o=l;c<t[n[r]]&&(r>0&&(e[s]=n[r-1]),n[r]=s)}}for(r=n.length,o=n[r-1];r-- >0;)n[r]=o,o=e[o];return n}function Bc(t){const e=t.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:Bc(e)}const Vd=t=>t.__isTeleport,Ge=Symbol.for("v-fgt"),ui=Symbol.for("v-txt"),qn=Symbol.for("v-cmt"),Ui=Symbol.for("v-stc"),Ln=[];let ke=null;function Bi(t=!1){Ln.push(ke=t?null:[])}function Wd(){Ln.pop(),ke=Ln[Ln.length-1]||null}let zn=1;function bl(t){zn+=t}function jd(t){return t.dynamicChildren=zn>0?ke||rn:null,Wd(),zn>0&&ke&&ke.push(t),t}function $i(t,e,n,s,i,r){return jd(Ne(t,e,n,s,i,r,!0))}function Gd(t){return t?t.__v_isVNode===!0:!1}function Tn(t,e){return t.type===e.type&&t.key===e.key}const $c=({key:t})=>t??null,Ns=({ref:t,ref_key:e,ref_for:n})=>(typeof t=="number"&&(t=""+t),t!=null?oe(t)||pe(t)||D(t)?{i:Re,r:t,k:e,f:!!n}:t:null);function Ne(t,e=null,n=null,s=0,i=null,r=t===Ge?0:1,o=!1,l=!1){const a={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&$c(e),ref:e&&Ns(e),scopeId:Cc,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:s,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:Re};return l?(eo(a,n),r&128&&t.normalize(a)):n&&(a.shapeFlag|=oe(n)?8:16),zn>0&&!o&&ke&&(a.patchFlag>0||r&6)&&a.patchFlag!==32&&ke.push(a),a}const $t=Kd;function Kd(t,e=null,n=null,s=0,i=null,r=!1){if((!t||t===od)&&(t=qn),Gd(t)){const l=fn(t,e,!0);return n&&eo(l,n),zn>0&&!r&&ke&&(l.shapeFlag&6?ke[ke.indexOf(t)]=l:ke.push(l)),l.patchFlag|=-2,l}if(np(t)&&(t=t.__vccOpts),e){e=qd(e);let{class:l,style:a}=e;l&&!oe(l)&&(e.class=ii(l)),ee(a)&&(fc(a)&&!O(a)&&(a=he({},a)),e.style=si(a))}const o=oe(t)?1:ld(t)?128:Vd(t)?64:ee(t)?4:D(t)?2:0;return Ne(t,e,n,s,i,o,r,!0)}function qd(t){return t?fc(t)||Pc(t)?he({},t):t:null}function fn(t,e,n=!1,s=!1){const{props:i,ref:r,patchFlag:o,children:l,transition:a}=t,c=e?zd(i||{},e):i,u={__v_isVNode:!0,__v_skip:!0,type:t.type,props:c,key:c&&$c(c),ref:e&&e.ref?n&&r?O(r)?r.concat(Ns(e)):[r,Ns(e)]:Ns(e):r,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:l,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Ge?o===-1?16:o|16:o,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:a,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&fn(t.ssContent),ssFallback:t.ssFallback&&fn(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce};return a&&s&&(u.transition=a.clone(u)),u}function Hc(t=" ",e=0){return $t(ui,null,t,e)}function Ke(t){return t==null||typeof t=="boolean"?$t(qn):O(t)?$t(Ge,null,t.slice()):typeof t=="object"?ct(t):$t(ui,null,String(t))}function ct(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:fn(t)}function eo(t,e){let n=0;const{shapeFlag:s}=t;if(e==null)e=null;else if(O(e))n=16;else if(typeof e=="object")if(s&65){const i=e.default;i&&(i._c&&(i._d=!1),eo(t,i()),i._c&&(i._d=!0));return}else{n=32;const i=e._;!i&&!Pc(e)?e._ctx=Re:i===3&&Re&&(Re.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else D(e)?(e={default:e,_ctx:Re},n=32):(e=String(e),s&64?(n=16,e=[Hc(e)]):n=8);t.children=e,t.shapeFlag|=n}function zd(...t){const e={};for(let n=0;n<t.length;n++){const s=t[n];for(const i in s)if(i==="class")e.class!==s.class&&(e.class=ii([e.class,s.class]));else if(i==="style")e.style=si([e.style,s.style]);else if(ei(i)){const r=e[i],o=s[i];o&&r!==o&&!(O(r)&&r.includes(o))&&(e[i]=r?[].concat(r,o):o)}else i!==""&&(e[i]=s[i])}return e}function je(t,e,n,s=null){Ue(t,e,7,[n,s])}const Yd=Nc();let Qd=0;function Jd(t,e,n){const s=t.type,i=(e?e.appContext:t.appContext)||Yd,r={uid:Qd++,vnode:t,type:s,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,scope:new Za(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Mc(s,i),emitsOptions:bc(s,i),emit:null,emitted:null,propsDefaults:J,inheritAttrs:s.inheritAttrs,ctx:J,data:J,props:J,attrs:J,slots:J,refs:J,setupState:J,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=e?e.root:r,r.emit=ed.bind(null,r),t.ce&&t.ce(r),r}let me=null,ks,mr;{const t=Qa(),e=(n,s)=>{let i;return(i=t[n])||(i=t[n]=[]),i.push(s),r=>{i.length>1?i.forEach(o=>o(r)):i[0](r)}};ks=e("__VUE_INSTANCE_SETTERS__",n=>me=n),mr=e("__VUE_SSR_SETTERS__",n=>hi=n)}const os=t=>{const e=me;return ks(t),t.scope.on(),()=>{t.scope.off(),ks(e)}},Cl=()=>{me&&me.scope.off(),ks(null)};function Vc(t){return t.vnode.shapeFlag&4}let hi=!1;function Xd(t,e=!1){e&&mr(e);const{props:n,children:s}=t.vnode,i=Vc(t);Dd(t,n,i,e),Ld(t,s);const r=i?Zd(t,e):void 0;return e&&mr(!1),r}function Zd(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=new Proxy(t.ctx,Id);const{setup:s}=n;if(s){const i=t.setupContext=s.length>1?tp(t):null,r=os(t);wt();const o=ft(s,t,0,[t.props,i]);if(Et(),r(),Ga(o)){if(o.then(Cl,Cl),e)return o.then(l=>{wl(t,l,e)}).catch(l=>{li(l,t,0)});t.asyncDep=o}else wl(t,o,e)}else Wc(t,e)}function wl(t,e,n){D(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:ee(e)&&(t.setupState=_c(e)),Wc(t,n)}let El;function Wc(t,e,n){const s=t.type;if(!t.render){if(!e&&El&&!s.render){const i=s.template||Xr(t).template;if(i){const{isCustomElement:r,compilerOptions:o}=t.appContext.config,{delimiters:l,compilerOptions:a}=s,c=he(he({isCustomElement:r,delimiters:l},o),a);s.render=El(i,c)}}t.render=s.render||xe}{const i=os(t);wt();try{Sd(t)}finally{Et(),i()}}}const ep={get(t,e){return Ee(t,"get",""),t[e]}};function tp(t){const e=n=>{t.exposed=n||{}};return{attrs:new Proxy(t.attrs,ep),slots:t.slots,emit:t.emit,expose:e}}function fi(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(_c(Wf(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in Mn)return Mn[n](t)},has(e,n){return n in e||n in Mn}}))}function np(t){return D(t)&&"__vccOpts"in t}const jc=(t,e)=>jf(t,e,hi),sp="3.4.26";/**
* @vue/runtime-dom v3.4.26
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const ip="http://www.w3.org/2000/svg",rp="http://www.w3.org/1998/Math/MathML",ut=typeof document<"u"?document:null,Il=ut&&ut.createElement("template"),op={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,s)=>{const i=e==="svg"?ut.createElementNS(ip,t):e==="mathml"?ut.createElementNS(rp,t):ut.createElement(t,n?{is:n}:void 0);return t==="select"&&s&&s.multiple!=null&&i.setAttribute("multiple",s.multiple),i},createText:t=>ut.createTextNode(t),createComment:t=>ut.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>ut.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,n,s,i,r){const o=n?n.previousSibling:e.lastChild;if(i&&(i===r||i.nextSibling))for(;e.insertBefore(i.cloneNode(!0),n),!(i===r||!(i=i.nextSibling)););else{Il.innerHTML=s==="svg"?`<svg>${t}</svg>`:s==="mathml"?`<math>${t}</math>`:t;const l=Il.content;if(s==="svg"||s==="mathml"){const a=l.firstChild;for(;a.firstChild;)l.appendChild(a.firstChild);l.removeChild(a)}e.insertBefore(l,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}},lp=Symbol("_vtc");function ap(t,e,n){const s=t[lp];s&&(e=(e?[e,...s]:[...s]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}const Sl=Symbol("_vod"),cp=Symbol("_vsh"),up=Symbol(""),hp=/(^|;)\s*display\s*:/;function fp(t,e,n){const s=t.style,i=oe(n);let r=!1;if(n&&!i){if(e)if(oe(e))for(const o of e.split(";")){const l=o.slice(0,o.indexOf(":")).trim();n[l]==null&&xs(s,l,"")}else for(const o in e)n[o]==null&&xs(s,o,"");for(const o in n)o==="display"&&(r=!0),xs(s,o,n[o])}else if(i){if(e!==n){const o=s[up];o&&(n+=";"+o),s.cssText=n,r=hp.test(n)}}else e&&t.removeAttribute("style");Sl in t&&(t[Sl]=r?s.display:"",t[cp]&&(s.display="none"))}const Tl=/\s*!important$/;function xs(t,e,n){if(O(n))n.forEach(s=>xs(t,e,s));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const s=dp(t,e);Tl.test(n)?t.setProperty(zt(s),n.replace(Tl,""),"important"):t[s]=n}}const Rl=["Webkit","Moz","ms"],Hi={};function dp(t,e){const n=Hi[e];if(n)return n;let s=hn(e);if(s!=="filter"&&s in t)return Hi[e]=s;s=za(s);for(let i=0;i<Rl.length;i++){const r=Rl[i]+s;if(r in t)return Hi[e]=r}return e}const Al="http://www.w3.org/1999/xlink";function pp(t,e,n,s,i){if(s&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(Al,e.slice(6,e.length)):t.setAttributeNS(Al,e,n);else{const r=vf(e);n==null||r&&!Ja(n)?t.removeAttribute(e):t.setAttribute(e,r?"":n)}}function _p(t,e,n,s,i,r,o){if(e==="innerHTML"||e==="textContent"){s&&o(s,i,r),t[e]=n??"";return}const l=t.tagName;if(e==="value"&&l!=="PROGRESS"&&!l.includes("-")){const c=l==="OPTION"?t.getAttribute("value")||"":t.value,u=n??"";(c!==u||!("_value"in t))&&(t.value=u),n==null&&t.removeAttribute(e),t._value=n;return}let a=!1;if(n===""||n==null){const c=typeof t[e];c==="boolean"?n=Ja(n):n==null&&c==="string"?(n="",a=!0):c==="number"&&(n=0,a=!0)}try{t[e]=n}catch{}a&&t.removeAttribute(e)}function nn(t,e,n,s){t.addEventListener(e,n,s)}function gp(t,e,n,s){t.removeEventListener(e,n,s)}const Nl=Symbol("_vei");function mp(t,e,n,s,i=null){const r=t[Nl]||(t[Nl]={}),o=r[e];if(s&&o)o.value=s;else{const[l,a]=yp(e);if(s){const c=r[e]=Cp(s,i);nn(t,l,c,a)}else o&&(gp(t,l,o,a),r[e]=void 0)}}const xl=/(?:Once|Passive|Capture)$/;function yp(t){let e;if(xl.test(t)){e={};let s;for(;s=t.match(xl);)t=t.slice(0,t.length-s[0].length),e[s[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):zt(t.slice(2)),e]}let Vi=0;const vp=Promise.resolve(),bp=()=>Vi||(vp.then(()=>Vi=0),Vi=Date.now());function Cp(t,e){const n=s=>{if(!s._vts)s._vts=Date.now();else if(s._vts<=n.attached)return;Ue(wp(s,n.value),e,5,[s])};return n.value=t,n.attached=bp(),n}function wp(t,e){if(O(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(s=>i=>!i._stopped&&s&&s(i))}else return e}const Ol=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&t.charCodeAt(2)>96&&t.charCodeAt(2)<123,Ep=(t,e,n,s,i,r,o,l,a)=>{const c=i==="svg";e==="class"?ap(t,s,c):e==="style"?fp(t,n,s):ei(e)?$r(e)||mp(t,e,n,s,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):Ip(t,e,s,c))?_p(t,e,s,r,o,l,a):(e==="true-value"?t._trueValue=s:e==="false-value"&&(t._falseValue=s),pp(t,e,s,c))};function Ip(t,e,n,s){if(s)return!!(e==="innerHTML"||e==="textContent"||e in t&&Ol(e)&&D(n));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const i=t.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return Ol(e)&&oe(n)?!1:e in t}const Pl=t=>{const e=t.props["onUpdate:modelValue"]||!1;return O(e)?n=>Ss(e,n):e};function Sp(t){t.target.composing=!0}function Dl(t){const e=t.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const Wi=Symbol("_assign"),Ml={created(t,{modifiers:{lazy:e,trim:n,number:s}},i){t[Wi]=Pl(i);const r=s||i.props&&i.props.type==="number";nn(t,e?"change":"input",o=>{if(o.target.composing)return;let l=t.value;n&&(l=l.trim()),r&&(l=or(l)),t[Wi](l)}),n&&nn(t,"change",()=>{t.value=t.value.trim()}),e||(nn(t,"compositionstart",Sp),nn(t,"compositionend",Dl),nn(t,"change",Dl))},mounted(t,{value:e}){t.value=e??""},beforeUpdate(t,{value:e,modifiers:{lazy:n,trim:s,number:i}},r){if(t[Wi]=Pl(r),t.composing)return;const o=(i||t.type==="number")&&!/^0\d/.test(t.value)?or(t.value):t.value,l=e??"";o!==l&&(document.activeElement===t&&t.type!=="range"&&(n||s&&t.value.trim()===l)||(t.value=l))}},Tp={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},Rp=(t,e)=>{const n=t._withKeys||(t._withKeys={}),s=e.join(".");return n[s]||(n[s]=i=>{if(!("key"in i))return;const r=zt(i.key);if(e.some(o=>o===r||Tp[o]===r))return t(i)})},Ap=he({patchProp:Ep},op);let kl;function Np(){return kl||(kl=Ud(Ap))}const xp=(...t)=>{const e=Np().createApp(...t),{mount:n}=e;return e.mount=s=>{const i=Pp(s);if(!i)return;const r=e._component;!D(r)&&!r.render&&!r.template&&(r.template=i.innerHTML),i.innerHTML="";const o=n(i,!1,Op(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},e};function Op(t){if(t instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&t instanceof MathMLElement)return"mathml"}function Pp(t){return oe(t)?document.querySelector(t):t}function Dp(){return Gc().__VUE_DEVTOOLS_GLOBAL_HOOK__}function Gc(){return typeof navigator<"u"&&typeof window<"u"?window:typeof globalThis<"u"?globalThis:{}}const Mp=typeof Proxy=="function",kp="devtools-plugin:setup",Lp="plugin:settings:set";let Zt,yr;function Fp(){var t;return Zt!==void 0||(typeof window<"u"&&window.performance?(Zt=!0,yr=window.performance):typeof globalThis<"u"&&(!((t=globalThis.perf_hooks)===null||t===void 0)&&t.performance)?(Zt=!0,yr=globalThis.perf_hooks.performance):Zt=!1),Zt}function Up(){return Fp()?yr.now():Date.now()}class Bp{constructor(e,n){this.target=null,this.targetQueue=[],this.onQueue=[],this.plugin=e,this.hook=n;const s={};if(e.settings)for(const o in e.settings){const l=e.settings[o];s[o]=l.defaultValue}const i=`__vue-devtools-plugin-settings__${e.id}`;let r=Object.assign({},s);try{const o=localStorage.getItem(i),l=JSON.parse(o);Object.assign(r,l)}catch{}this.fallbacks={getSettings(){return r},setSettings(o){try{localStorage.setItem(i,JSON.stringify(o))}catch{}r=o},now(){return Up()}},n&&n.on(Lp,(o,l)=>{o===this.plugin.id&&this.fallbacks.setSettings(l)}),this.proxiedOn=new Proxy({},{get:(o,l)=>this.target?this.target.on[l]:(...a)=>{this.onQueue.push({method:l,args:a})}}),this.proxiedTarget=new Proxy({},{get:(o,l)=>this.target?this.target[l]:l==="on"?this.proxiedOn:Object.keys(this.fallbacks).includes(l)?(...a)=>(this.targetQueue.push({method:l,args:a,resolve:()=>{}}),this.fallbacks[l](...a)):(...a)=>new Promise(c=>{this.targetQueue.push({method:l,args:a,resolve:c})})})}async setRealTarget(e){this.target=e;for(const n of this.onQueue)this.target.on[n.method](...n.args);for(const n of this.targetQueue)n.resolve(await this.target[n.method](...n.args))}}function $p(t,e){const n=t,s=Gc(),i=Dp(),r=Mp&&n.enableEarlyProxy;if(i&&(s.__VUE_DEVTOOLS_PLUGIN_API_AVAILABLE__||!r))i.emit(kp,t,e);else{const o=r?new Bp(n,i):null;(s.__VUE_DEVTOOLS_PLUGINS__=s.__VUE_DEVTOOLS_PLUGINS__||[]).push({pluginDescriptor:n,setupFn:e,proxy:o}),o&&e(o.proxiedTarget)}}/*!
 * vuex v4.1.0
 * (c) 2022 Evan You
 * @license MIT
 */var Hp="store";function mn(t,e){Object.keys(t).forEach(function(n){return e(t[n],n)})}function Vp(t){return t!==null&&typeof t=="object"}function Wp(t){return t&&typeof t.then=="function"}function jp(t,e){return function(){return t(e)}}function Kc(t,e,n){return e.indexOf(t)<0&&(n&&n.prepend?e.unshift(t):e.push(t)),function(){var s=e.indexOf(t);s>-1&&e.splice(s,1)}}function qc(t,e){t._actions=Object.create(null),t._mutations=Object.create(null),t._wrappedGetters=Object.create(null),t._modulesNamespaceMap=Object.create(null);var n=t.state;di(t,n,[],t._modules.root,!0),to(t,n,e)}function to(t,e,n){var s=t._state,i=t._scope;t.getters={},t._makeLocalGettersCache=Object.create(null);var r=t._wrappedGetters,o={},l={},a=bf(!0);a.run(function(){mn(r,function(c,u){o[u]=jp(c,t),l[u]=jc(function(){return o[u]()}),Object.defineProperty(t.getters,u,{get:function(){return l[u].value},enumerable:!0})})}),t._state=oi({data:e}),t._scope=a,t.strict&&Yp(t),s&&n&&t._withCommit(function(){s.data=null}),i&&i.stop()}function di(t,e,n,s,i){var r=!n.length,o=t._modules.getNamespace(n);if(s.namespaced&&(t._modulesNamespaceMap[o],t._modulesNamespaceMap[o]=s),!r&&!i){var l=no(e,n.slice(0,-1)),a=n[n.length-1];t._withCommit(function(){l[a]=s.state})}var c=s.context=Gp(t,o,n);s.forEachMutation(function(u,h){var d=o+h;Kp(t,d,u,c)}),s.forEachAction(function(u,h){var d=u.root?h:o+h,_=u.handler||u;qp(t,d,_,c)}),s.forEachGetter(function(u,h){var d=o+h;zp(t,d,u,c)}),s.forEachChild(function(u,h){di(t,e,n.concat(h),u,i)})}function Gp(t,e,n){var s=e==="",i={dispatch:s?t.dispatch:function(r,o,l){var a=Ls(r,o,l),c=a.payload,u=a.options,h=a.type;return(!u||!u.root)&&(h=e+h),t.dispatch(h,c)},commit:s?t.commit:function(r,o,l){var a=Ls(r,o,l),c=a.payload,u=a.options,h=a.type;(!u||!u.root)&&(h=e+h),t.commit(h,c,u)}};return Object.defineProperties(i,{getters:{get:s?function(){return t.getters}:function(){return zc(t,e)}},state:{get:function(){return no(t.state,n)}}}),i}function zc(t,e){if(!t._makeLocalGettersCache[e]){var n={},s=e.length;Object.keys(t.getters).forEach(function(i){if(i.slice(0,s)===e){var r=i.slice(s);Object.defineProperty(n,r,{get:function(){return t.getters[i]},enumerable:!0})}}),t._makeLocalGettersCache[e]=n}return t._makeLocalGettersCache[e]}function Kp(t,e,n,s){var i=t._mutations[e]||(t._mutations[e]=[]);i.push(function(o){n.call(t,s.state,o)})}function qp(t,e,n,s){var i=t._actions[e]||(t._actions[e]=[]);i.push(function(o){var l=n.call(t,{dispatch:s.dispatch,commit:s.commit,getters:s.getters,state:s.state,rootGetters:t.getters,rootState:t.state},o);return Wp(l)||(l=Promise.resolve(l)),t._devtoolHook?l.catch(function(a){throw t._devtoolHook.emit("vuex:error",a),a}):l})}function zp(t,e,n,s){t._wrappedGetters[e]||(t._wrappedGetters[e]=function(r){return n(s.state,s.getters,r.state,r.getters)})}function Yp(t){an(function(){return t._state.data},function(){},{deep:!0,flush:"sync"})}function no(t,e){return e.reduce(function(n,s){return n[s]},t)}function Ls(t,e,n){return Vp(t)&&t.type&&(n=e,e=t,t=t.type),{type:t,payload:e,options:n}}var Qp="vuex bindings",Ll="vuex:mutations",ji="vuex:actions",en="vuex",Jp=0;function Xp(t,e){$p({id:"org.vuejs.vuex",app:t,label:"Vuex",homepage:"https://next.vuex.vuejs.org/",logo:"https://vuejs.org/images/icons/favicon-96x96.png",packageName:"vuex",componentStateTypes:[Qp]},function(n){n.addTimelineLayer({id:Ll,label:"Vuex Mutations",color:Fl}),n.addTimelineLayer({id:ji,label:"Vuex Actions",color:Fl}),n.addInspector({id:en,label:"Vuex",icon:"storage",treeFilterPlaceholder:"Filter stores..."}),n.on.getInspectorTree(function(s){if(s.app===t&&s.inspectorId===en)if(s.filter){var i=[];Xc(i,e._modules.root,s.filter,""),s.rootNodes=i}else s.rootNodes=[Jc(e._modules.root,"")]}),n.on.getInspectorState(function(s){if(s.app===t&&s.inspectorId===en){var i=s.nodeId;zc(e,i),s.state=t_(s_(e._modules,i),i==="root"?e.getters:e._makeLocalGettersCache,i)}}),n.on.editInspectorState(function(s){if(s.app===t&&s.inspectorId===en){var i=s.nodeId,r=s.path;i!=="root"&&(r=i.split("/").filter(Boolean).concat(r)),e._withCommit(function(){s.set(e._state.data,r,s.state.value)})}}),e.subscribe(function(s,i){var r={};s.payload&&(r.payload=s.payload),r.state=i,n.notifyComponentUpdate(),n.sendInspectorTree(en),n.sendInspectorState(en),n.addTimelineEvent({layerId:Ll,event:{time:Date.now(),title:s.type,data:r}})}),e.subscribeAction({before:function(s,i){var r={};s.payload&&(r.payload=s.payload),s._id=Jp++,s._time=Date.now(),r.state=i,n.addTimelineEvent({layerId:ji,event:{time:s._time,title:s.type,groupId:s._id,subtitle:"start",data:r}})},after:function(s,i){var r={},o=Date.now()-s._time;r.duration={_custom:{type:"duration",display:o+"ms",tooltip:"Action duration",value:o}},s.payload&&(r.payload=s.payload),r.state=i,n.addTimelineEvent({layerId:ji,event:{time:Date.now(),title:s.type,groupId:s._id,subtitle:"end",data:r}})}})})}var Fl=8702998,Zp=6710886,e_=16777215,Yc={label:"namespaced",textColor:e_,backgroundColor:Zp};function Qc(t){return t&&t!=="root"?t.split("/").slice(-2,-1)[0]:"Root"}function Jc(t,e){return{id:e||"root",label:Qc(e),tags:t.namespaced?[Yc]:[],children:Object.keys(t._children).map(function(n){return Jc(t._children[n],e+n+"/")})}}function Xc(t,e,n,s){s.includes(n)&&t.push({id:s||"root",label:s.endsWith("/")?s.slice(0,s.length-1):s||"Root",tags:e.namespaced?[Yc]:[]}),Object.keys(e._children).forEach(function(i){Xc(t,e._children[i],n,s+i+"/")})}function t_(t,e,n){e=n==="root"?e:e[n];var s=Object.keys(e),i={state:Object.keys(t.state).map(function(o){return{key:o,editable:!0,value:t.state[o]}})};if(s.length){var r=n_(e);i.getters=Object.keys(r).map(function(o){return{key:o.endsWith("/")?Qc(o):o,editable:!1,value:vr(function(){return r[o]})}})}return i}function n_(t){var e={};return Object.keys(t).forEach(function(n){var s=n.split("/");if(s.length>1){var i=e,r=s.pop();s.forEach(function(o){i[o]||(i[o]={_custom:{value:{},display:o,tooltip:"Module",abstract:!0}}),i=i[o]._custom.value}),i[r]=vr(function(){return t[n]})}else e[n]=vr(function(){return t[n]})}),e}function s_(t,e){var n=e.split("/").filter(function(s){return s});return n.reduce(function(s,i,r){var o=s[i];if(!o)throw new Error('Missing module "'+i+'" for path "'+e+'".');return r===n.length-1?o:o._children},e==="root"?t:t.root._children)}function vr(t){try{return t()}catch(e){return e}}var $e=function(e,n){this.runtime=n,this._children=Object.create(null),this._rawModule=e;var s=e.state;this.state=(typeof s=="function"?s():s)||{}},Zc={namespaced:{configurable:!0}};Zc.namespaced.get=function(){return!!this._rawModule.namespaced};$e.prototype.addChild=function(e,n){this._children[e]=n};$e.prototype.removeChild=function(e){delete this._children[e]};$e.prototype.getChild=function(e){return this._children[e]};$e.prototype.hasChild=function(e){return e in this._children};$e.prototype.update=function(e){this._rawModule.namespaced=e.namespaced,e.actions&&(this._rawModule.actions=e.actions),e.mutations&&(this._rawModule.mutations=e.mutations),e.getters&&(this._rawModule.getters=e.getters)};$e.prototype.forEachChild=function(e){mn(this._children,e)};$e.prototype.forEachGetter=function(e){this._rawModule.getters&&mn(this._rawModule.getters,e)};$e.prototype.forEachAction=function(e){this._rawModule.actions&&mn(this._rawModule.actions,e)};$e.prototype.forEachMutation=function(e){this._rawModule.mutations&&mn(this._rawModule.mutations,e)};Object.defineProperties($e.prototype,Zc);var Yt=function(e){this.register([],e,!1)};Yt.prototype.get=function(e){return e.reduce(function(n,s){return n.getChild(s)},this.root)};Yt.prototype.getNamespace=function(e){var n=this.root;return e.reduce(function(s,i){return n=n.getChild(i),s+(n.namespaced?i+"/":"")},"")};Yt.prototype.update=function(e){eu([],this.root,e)};Yt.prototype.register=function(e,n,s){var i=this;s===void 0&&(s=!0);var r=new $e(n,s);if(e.length===0)this.root=r;else{var o=this.get(e.slice(0,-1));o.addChild(e[e.length-1],r)}n.modules&&mn(n.modules,function(l,a){i.register(e.concat(a),l,s)})};Yt.prototype.unregister=function(e){var n=this.get(e.slice(0,-1)),s=e[e.length-1],i=n.getChild(s);i&&i.runtime&&n.removeChild(s)};Yt.prototype.isRegistered=function(e){var n=this.get(e.slice(0,-1)),s=e[e.length-1];return n?n.hasChild(s):!1};function eu(t,e,n){if(e.update(n),n.modules)for(var s in n.modules){if(!e.getChild(s))return;eu(t.concat(s),e.getChild(s),n.modules[s])}}function i_(t){return new Se(t)}var Se=function(e){var n=this;e===void 0&&(e={});var s=e.plugins;s===void 0&&(s=[]);var i=e.strict;i===void 0&&(i=!1);var r=e.devtools;this._committing=!1,this._actions=Object.create(null),this._actionSubscribers=[],this._mutations=Object.create(null),this._wrappedGetters=Object.create(null),this._modules=new Yt(e),this._modulesNamespaceMap=Object.create(null),this._subscribers=[],this._makeLocalGettersCache=Object.create(null),this._scope=null,this._devtools=r;var o=this,l=this,a=l.dispatch,c=l.commit;this.dispatch=function(d,_){return a.call(o,d,_)},this.commit=function(d,_,I){return c.call(o,d,_,I)},this.strict=i;var u=this._modules.root.state;di(this,u,[],this._modules.root),to(this,u),s.forEach(function(h){return h(n)})},so={state:{configurable:!0}};Se.prototype.install=function(e,n){e.provide(n||Hp,this),e.config.globalProperties.$store=this;var s=this._devtools!==void 0?this._devtools:!1;s&&Xp(e,this)};so.state.get=function(){return this._state.data};so.state.set=function(t){};Se.prototype.commit=function(e,n,s){var i=this,r=Ls(e,n,s),o=r.type,l=r.payload,a={type:o,payload:l},c=this._mutations[o];c&&(this._withCommit(function(){c.forEach(function(h){h(l)})}),this._subscribers.slice().forEach(function(u){return u(a,i.state)}))};Se.prototype.dispatch=function(e,n){var s=this,i=Ls(e,n),r=i.type,o=i.payload,l={type:r,payload:o},a=this._actions[r];if(a){try{this._actionSubscribers.slice().filter(function(u){return u.before}).forEach(function(u){return u.before(l,s.state)})}catch{}var c=a.length>1?Promise.all(a.map(function(u){return u(o)})):a[0](o);return new Promise(function(u,h){c.then(function(d){try{s._actionSubscribers.filter(function(_){return _.after}).forEach(function(_){return _.after(l,s.state)})}catch{}u(d)},function(d){try{s._actionSubscribers.filter(function(_){return _.error}).forEach(function(_){return _.error(l,s.state,d)})}catch{}h(d)})})}};Se.prototype.subscribe=function(e,n){return Kc(e,this._subscribers,n)};Se.prototype.subscribeAction=function(e,n){var s=typeof e=="function"?{before:e}:e;return Kc(s,this._actionSubscribers,n)};Se.prototype.watch=function(e,n,s){var i=this;return an(function(){return e(i.state,i.getters)},n,Object.assign({},s))};Se.prototype.replaceState=function(e){var n=this;this._withCommit(function(){n._state.data=e})};Se.prototype.registerModule=function(e,n,s){s===void 0&&(s={}),typeof e=="string"&&(e=[e]),this._modules.register(e,n),di(this,this.state,e,this._modules.get(e),s.preserveState),to(this,this.state)};Se.prototype.unregisterModule=function(e){var n=this;typeof e=="string"&&(e=[e]),this._modules.unregister(e),this._withCommit(function(){var s=no(n.state,e.slice(0,-1));delete s[e[e.length-1]]}),qc(this)};Se.prototype.hasModule=function(e){return typeof e=="string"&&(e=[e]),this._modules.isRegistered(e)};Se.prototype.hotUpdate=function(e){this._modules.update(e),qc(this,!0)};Se.prototype._withCommit=function(e){var n=this._committing;this._committing=!0,e(),this._committing=n};Object.defineProperties(Se.prototype,so);var Ul={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const b_="FirebaseError";class Qt extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=b_,Object.setPrototypeOf(this,Qt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,_i.prototype.create)}}class _i{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?C_(r,s):"Error",l=`${this.serviceName}: ${o} (${i}).`;return new Qt(i,l,s)}}function C_(t,e){return t.replace(w_,(n,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const w_=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hu=function(t){let e={},n={},s={},i="";try{const r=t.split(".");e=Yn(br(r[0])||""),n=Yn(br(r[1])||""),i=r[2],s=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:s,signature:i}},E_=function(t){const e=hu(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},I_=function(t){const e=hu(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function S_(t){const e=[];for(const[n,s]of Object.entries(t))Array.isArray(s)?s.forEach(i=>{e.push(encodeURIComponent(n)+"="+encodeURIComponent(i))}):e.push(encodeURIComponent(n)+"="+encodeURIComponent(s));return e.length?"&"+e.join("&"):""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var q;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(q||(q={}));const L_={debug:q.DEBUG,verbose:q.VERBOSE,info:q.INFO,warn:q.WARN,error:q.ERROR,silent:q.SILENT},F_=q.INFO,U_={[q.DEBUG]:"log",[q.VERBOSE]:"log",[q.INFO]:"info",[q.WARN]:"warn",[q.ERROR]:"error"},B_=(t,e,...n)=>{if(e<t.logLevel)return;const s=new Date().toISOString(),i=U_[e];if(i)console[i](`[${s}]  ${t.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class oo{constructor(e){this.name=e,this._logLevel=F_,this._logHandler=B_,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in q))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?L_[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,q.DEBUG,...e),this._logHandler(this,q.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,q.VERBOSE,...e),this._logHandler(this,q.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,q.INFO,...e),this._logHandler(this,q.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,q.WARN,...e),this._logHandler(this,q.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,q.ERROR,...e),this._logHandler(this,q.ERROR,...e)}}const $_=(t,e)=>e.some(n=>t instanceof n);let Vl,Wl;function H_(){return Vl||(Vl=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function V_(){return Wl||(Wl=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const fu=new WeakMap,wr=new WeakMap,du=new WeakMap,Gi=new WeakMap,lo=new WeakMap;function W_(t){const e=new Promise((n,s)=>{const i=()=>{t.removeEventListener("success",r),t.removeEventListener("error",o)},r=()=>{n(dt(t.result)),i()},o=()=>{s(t.error),i()};t.addEventListener("success",r),t.addEventListener("error",o)});return e.then(n=>{n instanceof IDBCursor&&fu.set(n,t)}).catch(()=>{}),lo.set(e,t),e}function j_(t){if(wr.has(t))return;const e=new Promise((n,s)=>{const i=()=>{t.removeEventListener("complete",r),t.removeEventListener("error",o),t.removeEventListener("abort",o)},r=()=>{n(),i()},o=()=>{s(t.error||new DOMException("AbortError","AbortError")),i()};t.addEventListener("complete",r),t.addEventListener("error",o),t.addEventListener("abort",o)});wr.set(t,e)}let Er={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return wr.get(t);if(e==="objectStoreNames")return t.objectStoreNames||du.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return dt(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function G_(t){Er=t(Er)}function K_(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const s=t.call(Ki(this),e,...n);return du.set(s,e.sort?e.sort():[e]),dt(s)}:V_().includes(t)?function(...e){return t.apply(Ki(this),e),dt(fu.get(this))}:function(...e){return dt(t.apply(Ki(this),e))}}function q_(t){return typeof t=="function"?K_(t):(t instanceof IDBTransaction&&j_(t),$_(t,H_())?new Proxy(t,Er):t)}function dt(t){if(t instanceof IDBRequest)return W_(t);if(Gi.has(t))return Gi.get(t);const e=q_(t);return e!==t&&(Gi.set(t,e),lo.set(e,t)),e}const Ki=t=>lo.get(t);function pu(t,e,{blocked:n,upgrade:s,blocking:i,terminated:r}={}){const o=indexedDB.open(t,e),l=dt(o);return s&&o.addEventListener("upgradeneeded",a=>{s(dt(o.result),a.oldVersion,a.newVersion,dt(o.transaction),a)}),n&&o.addEventListener("blocked",a=>n(a.oldVersion,a.newVersion,a)),l.then(a=>{r&&a.addEventListener("close",()=>r()),i&&a.addEventListener("versionchange",c=>i(c.oldVersion,c.newVersion,c))}).catch(()=>{}),l}const z_=["get","getKey","getAll","getAllKeys","count"],Y_=["put","add","delete","clear"],qi=new Map;function jl(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(qi.get(e))return qi.get(e);const n=e.replace(/FromIndex$/,""),s=e!==n,i=Y_.includes(n);if(!(n in(s?IDBIndex:IDBObjectStore).prototype)||!(i||z_.includes(n)))return;const r=async function(o,...l){const a=this.transaction(o,i?"readwrite":"readonly");let c=a.store;return s&&(c=c.index(l.shift())),(await Promise.all([c[n](...l),i&&a.done]))[0]};return qi.set(e,r),r}G_(t=>({...t,get:(e,n,s)=>jl(e,n)||t.get(e,n,s),has:(e,n)=>!!jl(e,n)||t.has(e,n)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Q_{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(J_(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function J_(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Ir="@firebase/app",Gl="0.10.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sr="[DEFAULT]",Eg={[Ir]:"fire-core",[X_]:"fire-core-compat",[eg]:"fire-analytics",[Z_]:"fire-analytics-compat",[ng]:"fire-app-check",[tg]:"fire-app-check-compat",[sg]:"fire-auth",[ig]:"fire-auth-compat",[rg]:"fire-rtdb",[og]:"fire-rtdb-compat",[lg]:"fire-fn",[ag]:"fire-fn-compat",[cg]:"fire-iid",[ug]:"fire-iid-compat",[hg]:"fire-fcm",[fg]:"fire-fcm-compat",[dg]:"fire-perf",[pg]:"fire-perf-compat",[_g]:"fire-rc",[gg]:"fire-rc-compat",[mg]:"fire-gcs",[yg]:"fire-gcs-compat",[vg]:"fire-fst",[bg]:"fire-fst-compat","fire-js":"fire-js",[Cg]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bs=new Map,Ig=new Map,Tr=new Map;function Kl(t,e){try{t.container.addComponent(e)}catch(n){Ht.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function yt(t){const e=t.name;if(Tr.has(e))return Ht.debug(`There were multiple attempts to register component ${e}.`),!1;Tr.set(e,t);for(const n of Bs.values())Kl(n,t);for(const n of Ig.values())Kl(n,t);return!0}function ao(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rg=wg;function _u(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:Sr,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw pt.create("bad-app-name",{appName:String(i)});if(n||(n=ou()),!n)throw pt.create("no-options");const r=Bs.get(i);if(r){if(Cr(n,r.options)&&Cr(s,r.config))return r;throw pt.create("duplicate-app",{appName:i})}const o=new k_(i);for(const a of Tr.values())o.addComponent(a);const l=new Tg(n,s,o);return Bs.set(i,l),l}function Ag(t=Sr){const e=Bs.get(t);if(!e&&t===Sr&&ou())return _u();if(!e)throw pt.create("no-app",{appName:t});return e}function ze(t,e,n){var s;let i=(s=Eg[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const l=[`Unable to register library "${i}" with version "${e}":`];r&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ht.warn(l.join(" "));return}yt(new tt(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ng="firebase-heartbeat-database",xg=1,Qn="firebase-heartbeat-store";let zi=null;function gu(){return zi||(zi=pu(Ng,xg,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Qn)}catch(n){console.warn(n)}}}}).catch(t=>{throw pt.create("idb-open",{originalErrorMessage:t.message})})),zi}async function Og(t){try{const n=(await gu()).transaction(Qn),s=await n.objectStore(Qn).get(mu(t));return await n.done,s}catch(e){if(e instanceof Qt)Ht.warn(e.message);else{const n=pt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Ht.warn(n.message)}}}async function ql(t,e){try{const s=(await gu()).transaction(Qn,"readwrite");await s.objectStore(Qn).put(e,mu(t)),await s.done}catch(n){if(n instanceof Qt)Ht.warn(n.message);else{const s=pt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Ht.warn(s.message)}}}function mu(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fg(t){yt(new tt("platform-logger",e=>new Q_(e),"PRIVATE")),yt(new tt("heartbeat",e=>new Mg(e),"PRIVATE")),ze(Ir,Gl,t),ze(Ir,Gl,"esm2017"),ze("fire-js","")}Fg("");var Ug="firebase",Bg="10.11.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ze(Ug,Bg,"app");const yu="@firebase/installations",co="0.6.6";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vu=1e4,bu=`w:${co}`,Cu="FIS_v2",$g="https://firebaseinstallations.googleapis.com/v1",Hg=60*60*1e3,Vg="installations",Wg="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Eu({projectId:t}){return`${$g}/projects/${t}/installations`}function Iu(t){return{token:t.token,requestStatus:2,expiresIn:Kg(t.expiresIn),creationTime:Date.now()}}async function Su(t,e){const s=(await e.json()).error;return Vt.create("request-failed",{requestName:t,serverCode:s.code,serverMessage:s.message,serverStatus:s.status})}function Tu({apiKey:t}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t})}function Gg(t,{refreshToken:e}){const n=Tu(t);return n.append("Authorization",qg(e)),n}async function Ru(t){const e=await t();return e.status>=500&&e.status<600?t():e}function Kg(t){return Number(t.replace("s","000"))}function qg(t){return`${Cu} ${t}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zg({appConfig:t,heartbeatServiceProvider:e},{fid:n}){const s=Eu(t),i=Tu(t),r=e.getImmediate({optional:!0});if(r){const c=await r.getHeartbeatsHeader();c&&i.append("x-firebase-client",c)}const o={fid:n,authVersion:Cu,appId:t.appId,sdkVersion:bu},l={method:"POST",headers:i,body:JSON.stringify(o)},a=await Ru(()=>fetch(s,l));if(a.ok){const c=await a.json();return{fid:c.fid||n,registrationStatus:2,refreshToken:c.refreshToken,authToken:Iu(c.authToken)}}else throw await Su("Create Installation",a)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qg=/^[cdef][\w-]{21}$/,Rr="";function Jg(){try{const t=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(t),t[0]=112+t[0]%16;const n=Xg(t);return Qg.test(n)?n:Rr}catch{return Rr}}function Xg(t){return Yg(t).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nu=new Map;function xu(t,e){const n=mi(t);Ou(n,e),Zg(n,e)}function Ou(t,e){const n=Nu.get(t);if(n)for(const s of n)s(e)}function Zg(t,e){const n=em();n&&n.postMessage({key:t,fid:e}),tm()}let kt=null;function em(){return!kt&&"BroadcastChannel"in self&&(kt=new BroadcastChannel("[Firebase] FID Change"),kt.onmessage=t=>{Ou(t.data.key,t.data.fid)}),kt}function tm(){Nu.size===0&&kt&&(kt.close(),kt=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nm="firebase-installations-database",sm=1,Wt="firebase-installations-store";let Yi=null;function uo(){return Yi||(Yi=pu(nm,sm,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Wt)}}})),Yi}async function $s(t,e){const n=mi(t),i=(await uo()).transaction(Wt,"readwrite"),r=i.objectStore(Wt),o=await r.get(n);return await r.put(e,n),await i.done,(!o||o.fid!==e.fid)&&xu(t,e.fid),e}async function Pu(t){const e=mi(t),s=(await uo()).transaction(Wt,"readwrite");await s.objectStore(Wt).delete(e),await s.done}async function yi(t,e){const n=mi(t),i=(await uo()).transaction(Wt,"readwrite"),r=i.objectStore(Wt),o=await r.get(n),l=e(o);return l===void 0?await r.delete(n):await r.put(l,n),await i.done,l&&(!o||o.fid!==l.fid)&&xu(t,l.fid),l}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mm(t){const e=t,{installationEntry:n,registrationPromise:s}=await ho(e);return s?s.catch(console.error):fo(e).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ym(t,e=!1){const n=t;return await vm(n),(await fo(n,e)).token}async function vm(t){const{registrationPromise:e}=await ho(t);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bm(t){if(!t||!t.options)throw Qi("App Configuration");if(!t.name)throw Qi("App Name");const e=["projectId","apiKey","appId"];for(const n of e)if(!t.options[n])throw Qi(n);return{appName:t.name,projectId:t.options.projectId,apiKey:t.options.apiKey,appId:t.options.appId}}function Qi(t){return Vt.create("missing-app-config-values",{valueName:t})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ku="installations",Cm="installations-internal",wm=t=>{const e=t.getProvider("app").getImmediate(),n=bm(e),s=ao(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},Em=t=>{const e=t.getProvider("app").getImmediate(),n=ao(e,ku).getImmediate();return{getId:()=>mm(n),getToken:i=>ym(n,i)}};function Im(){yt(new tt(ku,wm,"PUBLIC")),yt(new tt(Cm,Em,"PRIVATE"))}Im();ze(yu,co);ze(yu,co,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xl="analytics",Sm="firebase_id",Tm="origin",Rm=60*1e3,Am="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",po="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ce=new oo("@firebase/analytics");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ym(){if(cu())try{await uu()}catch(t){return Ce.warn(Oe.create("indexeddb-unavailable",{errorInfo:t==null?void 0:t.toString()}).message),!1}else return Ce.warn(Oe.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function Qm(t,e,n,s,i,r,o){var l;const a=jm(t);a.then(_=>{n[_.measurementId]=_.appId,t.options.measurementId&&_.measurementId!==t.options.measurementId&&Ce.warn(`The measurement ID in the local Firebase config (${t.options.measurementId}) does not match the measurement ID fetched from the server (${_.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(_=>Ce.error(_)),e.push(a);const c=Ym().then(_=>{if(_)return s.getId()}),[u,h]=await Promise.all([a,c]);Um(r)||Pm(r,u.measurementId),i("js",new Date);const d=(l=o==null?void 0:o.config)!==null&&l!==void 0?l:{};return d[Tm]="firebase",d.update=!0,h!=null&&(d[Sm]=h),i("config",u.measurementId,d),u.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jm{constructor(e){this.app=e}_delete(){return delete Fn[this.app.options.appId],Promise.resolve()}}let Fn={},Zl=[];const ea={};let Ji="dataLayer",Xm="gtag",ta,Bu,na=!1;function Zm(){const t=[];if(m_()&&t.push("This is a browser extension environment."),v_()||t.push("Cookies are not available."),t.length>0){const e=t.map((s,i)=>`(${i+1}) ${s}`).join(" "),n=Oe.create("invalid-analytics-context",{errorInfo:e});Ce.warn(n.message)}}function ey(t,e,n){Zm();const s=t.options.appId;if(!s)throw Oe.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)Ce.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw Oe.create("no-api-key");if(Fn[s]!=null)throw Oe.create("already-exists",{id:s});if(!na){Dm(Ji);const{wrappedGtag:r,gtagCore:o}=Fm(Fn,Zl,ea,Ji,Xm);Bu=r,ta=o,na=!0}return Fn[s]=Qm(t,Zl,ea,e,ta,Ji,n),new Jm(t)}function ty(t,e,n,s){t=It(t),zm(Bu,Fn[t.app.options.appId],e,n,s).catch(i=>Ce.error(i))}const sa="@firebase/analytics",ia="0.10.2";function ny(){yt(new tt(Xl,(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return ey(s,i,n)},"PUBLIC")),yt(new tt("analytics-internal",t,"PRIVATE")),ze(sa,ia),ze(sa,ia,"esm2017");function t(e){try{const n=e.getProvider(Xl).getImmediate();return{logEvent:(s,i,r)=>ty(n,s,i,r)}}catch(n){throw Oe.create("interop-component-reg-failed",{reason:n})}}}ny();var ra={};const oa="@firebase/database",la="1.0.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hu=function(t){try{if(typeof window<"u"&&typeof window[t]<"u"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new iy(e)}}catch{}return new ry},Lt=Hu("localStorage"),oy=Hu("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const go="5",Ku="v",qu="s",zu="r",Yu="f",Qu=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Ju="ls",Xu="p",Nr="ac",Zu="websocket",eh="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xi={},Zi={};function mo(t){const e=t.toString();return Xi[e]||(Xi[e]=new wy),Xi[e]}function Ey(t,e){const n=t.toString();return Zi[n]||(Zi[n]=e()),Zi[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ma=32,ya=768;class G{constructor(e,n){if(n===void 0){this.pieces_=e.split("/");let s=0;for(let i=0;i<this.pieces_.length;i++)this.pieces_[i].length>0&&(this.pieces_[s]=this.pieces_[i],s++);this.pieces_.length=s,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=n}toString(){let e="";for(let n=this.pieceNum_;n<this.pieces_.length;n++)this.pieces_[n]!==""&&(e+="/"+this.pieces_[n]);return e||"/"}}function B(){return new G("")}function M(t){return t.pieceNum_>=t.pieces_.length?null:t.pieces_[t.pieceNum_]}function vt(t){return t.pieces_.length-t.pieceNum_}function z(t){let e=t.pieceNum_;return e<t.pieces_.length&&e++,new G(t.pieces_,e)}function uh(t){return t.pieceNum_<t.pieces_.length?t.pieces_[t.pieces_.length-1]:null}function Ky(t){let e="";for(let n=t.pieceNum_;n<t.pieces_.length;n++)t.pieces_[n]!==""&&(e+="/"+encodeURIComponent(String(t.pieces_[n])));return e||"/"}function hh(t,e=0){return t.pieces_.slice(t.pieceNum_+e)}function fh(t){if(t.pieceNum_>=t.pieces_.length)return null;const e=[];for(let n=t.pieceNum_;n<t.pieces_.length-1;n++)e.push(t.pieces_[n]);return new G(e,0)}function re(t,e){const n=[];for(let s=t.pieceNum_;s<t.pieces_.length;s++)n.push(t.pieces_[s]);if(e instanceof G)for(let s=e.pieceNum_;s<e.pieces_.length;s++)n.push(e.pieces_[s]);else{const s=e.split("/");for(let i=0;i<s.length;i++)s[i].length>0&&n.push(s[i])}return new G(n,0)}function L(t){return t.pieceNum_>=t.pieces_.length}function ye(t,e){const n=M(t),s=M(e);if(n===null)return e;if(n===s)return ye(z(t),z(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+t+")")}function vo(t,e){if(vt(t)!==vt(e))return!1;for(let n=t.pieceNum_,s=e.pieceNum_;n<=t.pieces_.length;n++,s++)if(t.pieces_[n]!==e.pieces_[s])return!1;return!0}function Le(t,e){let n=t.pieceNum_,s=e.pieceNum_;if(vt(t)>vt(e))return!1;for(;n<t.pieces_.length;){if(t.pieces_[n]!==e.pieces_[s])return!1;++n,++s}return!0}class qy{constructor(e,n){this.errorPrefix_=n,this.parts_=hh(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let s=0;s<this.parts_.length;s++)this.byteLength_+=gi(this.parts_[s]);dh(this)}}function zy(t,e){t.parts_.length>0&&(t.byteLength_+=1),t.parts_.push(e),t.byteLength_+=gi(e),dh(t)}function Yy(t){const e=t.parts_.pop();t.byteLength_-=gi(e),t.parts_.length>0&&(t.byteLength_-=1)}function dh(t){if(t.byteLength_>ya)throw new Error(t.errorPrefix_+"has a key path longer than "+ya+" bytes ("+t.byteLength_+").");if(t.parts_.length>ma)throw new Error(t.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+ma+") or object contains a cycle "+Pt(t))}function Pt(t){return t.parts_.length===0?"":"in property '"+t.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bo extends ch{constructor(){super(["visible"]);let e,n;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(n="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(n="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(n="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(n="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,n&&document.addEventListener(n,()=>{const s=!document[e];s!==this.visible_&&(this.visible_=s,this.trigger("visible",s))},!1)}static getInstance(){return new bo}getInitialEvent(e){return b(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vi{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,n){const s=new k(pn,e),i=new k(pn,n);return this.compare(s,i)!==0}minPost(){return k.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tv(t,e){return vn(t.name,e.name)}function Co(t,e){return vn(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let xr;function nv(t){xr=t}const _h=function(t){return typeof t=="number"?"number:"+Gu(t):"string:"+t},gh=function(t){if(t.isLeafNode()){const e=t.val();b(typeof e=="string"||typeof e=="number"||typeof e=="object"&&it(e,".sv"),"Priority must be a string or number.")}else b(t===xr||t.isEmpty(),"priority of unexpected type.");b(t===xr||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let mh,yh;function sv(t){mh=t}function iv(t){yh=t}class rv extends vi{compare(e,n){const s=e.node.getPriority(),i=n.node.getPriority(),r=s.compareTo(i);return r===0?vn(e.name,n.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return k.MIN}maxPost(){return new k(jt,new ae("[PRIORITY-POST]",yh))}makePost(e,n){const s=mh(e);return new k(n,new ae("[PRIORITY-POST]",s))}toString(){return".priority"}}const te=new rv;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tr;const tn={};class Xe{constructor(e,n){this.indexes_=e,this.indexSet_=n}static get Default(){return b(tn&&te,"ChildrenNode.ts has not been loaded"),tr=tr||new Xe({".priority":tn},{".priority":te}),tr}get(e){const n=dn(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof be?n:null}hasIndex(e){return it(this.indexSet_,e.toString())}addIndex(e,n){b(e!==un,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let i=!1;const r=n.getIterator(k.Wrap);let o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),s.push(o),o=r.getNext();let l;i?l=Ws(s,e.getCompare()):l=tn;const a=e.toString(),c=Object.assign({},this.indexSet_);c[a]=e;const u=Object.assign({},this.indexes_);return u[a]=l,new Xe(u,c)}addToIndexes(e,n){const s=Us(this.indexes_,(i,r)=>{const o=dn(this.indexSet_,r);if(b(o,"Missing index implementation for "+r),i===tn)if(o.isDefinedOn(e.node)){const l=[],a=n.getIterator(k.Wrap);let c=a.getNext();for(;c;)c.name!==e.name&&l.push(c),c=a.getNext();return l.push(e),Ws(l,o.getCompare())}else return tn;else{const l=n.get(e.name);let a=i;return l&&(a=a.remove(new k(e.name,l))),a.insert(e,e.node)}});return new Xe(s,this.indexSet_)}removeFromIndexes(e,n){const s=Us(this.indexes_,i=>{if(i===tn)return i;{const r=n.get(e.name);return r?i.remove(new k(e.name,r)):i}});return new Xe(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uv extends vi{constructor(e){super(),this.indexPath_=e,b(!L(e)&&M(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,n){const s=this.extractChild(e.node),i=this.extractChild(n.node),r=s.compareTo(i);return r===0?vn(e.name,n.name):r}makePost(e,n){const s=ue(e),i=x.EMPTY_NODE.updateChild(this.indexPath_,s);return new k(n,i)}maxPost(){const e=x.EMPTY_NODE.updateChild(this.indexPath_,cs);return new k(jt,e)}toString(){return hh(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hv extends vi{compare(e,n){const s=e.node.compareTo(n.node);return s===0?vn(e.name,n.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return k.MIN}maxPost(){return k.MAX}makePost(e,n){const s=ue(e);return new k(n,s)}toString(){return".value"}}const fv=new hv;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gs(){return{value:null,children:new Map}}function bh(t,e,n){if(L(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const s=M(e);t.children.has(s)||t.children.set(s,Gs());const i=t.children.get(s);e=z(e),bh(i,e,n)}}function Or(t,e,n){t.value!==null?n(e,t.value):mv(t,(s,i)=>{const r=new G(e.toString()+"/"+s);Or(i,r,n)})}function mv(t,e){t.children.forEach((n,s)=>{e(s,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Fe;(function(t){t[t.OVERWRITE=0]="OVERWRITE",t[t.MERGE=1]="MERGE",t[t.ACK_USER_WRITE=2]="ACK_USER_WRITE",t[t.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(Fe||(Fe={}));function Ch(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function Io(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function So(t){return{fromUser:!1,fromServer:!0,queryId:t,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt{constructor(e,n,s){this.source=e,this.path=n,this.snap=s,this.type=Fe.OVERWRITE}operationForChild(e){return L(this.path)?new Gt(this.source,B(),this.snap.getImmediateChild(e)):new Gt(this.source,z(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wv{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Ev(t,e,n,s){const i=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&t.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(dv(o.childName,o.snapshotNode))}),xn(t,i,"child_removed",e,s,n),xn(t,i,"child_added",e,s,n),xn(t,i,"child_moved",r,s,n),xn(t,i,"child_changed",e,s,n),xn(t,i,"value",e,s,n),i}function xn(t,e,n,s,i,r){const o=s.filter(l=>l.type===n);o.sort((l,a)=>Sv(t,l,a)),o.forEach(l=>{const a=Iv(t,l,r);i.forEach(c=>{c.respondsTo(l.type)&&e.push(c.createEvent(a,t.query_))})})}function Iv(t,e,n){return e.type==="value"||e.type==="child_removed"||(e.prevName=n.getPredecessorChildName(e.childName,e.snapshotNode,t.index_)),e}function Sv(t,e,n){if(e.childName==null||n.childName==null)throw yn("Should only compare child_ events.");const s=new k(e.childName,e.snapshotNode),i=new k(n.childName,n.snapshotNode);return t.index_.compare(s,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bi(t,e){return{eventCache:t,serverCache:e}}function $n(t,e,n,s){return bi(new bt(e,n,s),t.serverCache)}function wh(t,e,n,s){return bi(t.eventCache,new bt(e,n,s))}function qs(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function Kt(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ci(t,e){return Rh(e,t)}function Rv(t,e,n,s,i){b(s>t.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),t.allWrites.push({path:e,snap:n,writeId:s,visible:i}),i&&(t.visibleWrites=Hn(t.visibleWrites,e,n)),t.lastWriteId=s}function Av(t,e){for(let n=0;n<t.allWrites.length;n++){const s=t.allWrites[n];if(s.writeId===e)return s}return null}function Nv(t,e){const n=t.allWrites.findIndex(l=>l.writeId===e);b(n>=0,"removeWrite called with nonexistent writeId.");const s=t.allWrites[n];t.allWrites.splice(n,1);let i=s.visible,r=!1,o=t.allWrites.length-1;for(;i&&o>=0;){const l=t.allWrites[o];l.visible&&(o>=n&&xv(l,s.path)?i=!1:Le(s.path,l.path)&&(r=!0)),o--}if(i){if(r)return Ov(t),!0;if(s.snap)t.visibleWrites=Ta(t.visibleWrites,s.path);else{const l=s.children;Ie(l,a=>{t.visibleWrites=Ta(t.visibleWrites,re(s.path,a))})}return!0}else return!1}function xv(t,e){if(t.snap)return Le(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&Le(re(t.path,n),e))return!0;return!1}function Ov(t){t.visibleWrites=Ih(t.allWrites,Pv,B()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function Pv(t){return t.visible}function Ih(t,e,n){let s=Be.empty();for(let i=0;i<t.length;++i){const r=t[i];if(e(r)){const o=r.path;let l;if(r.snap)Le(n,o)?(l=ye(n,o),s=Hn(s,l,r.snap)):Le(o,n)&&(l=ye(o,n),s=Hn(s,B(),r.snap.getChild(l)));else if(r.children){if(Le(n,o))l=ye(n,o),s=Sa(s,l,r.children);else if(Le(o,n))if(l=ye(o,n),L(l))s=Sa(s,B(),r.children);else{const a=dn(r.children,M(l));if(a){const c=a.getChild(z(l));s=Hn(s,B(),c)}}}else throw yn("WriteRecord should have .snap or .children")}}return s}function Sh(t,e,n,s,i){if(!s&&!i){const r=Jt(t.visibleWrites,e);if(r!=null)return r;{const o=_t(t.visibleWrites,e);if(Dr(o))return n;if(n==null&&!Pr(o,B()))return null;{const l=n||x.EMPTY_NODE;return gn(o,l)}}}else{const r=_t(t.visibleWrites,e);if(!i&&Dr(r))return n;if(!i&&n==null&&!Pr(r,B()))return null;{const o=function(c){return(c.visible||i)&&(!s||!~s.indexOf(c.writeId))&&(Le(c.path,e)||Le(e,c.path))},l=Ih(t.allWrites,o,e),a=n||x.EMPTY_NODE;return gn(l,a)}}}function Dv(t,e,n){let s=x.EMPTY_NODE;const i=Jt(t.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(te,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(n){const r=_t(t.visibleWrites,e);return n.forEachChild(te,(o,l)=>{const a=gn(_t(r,new G(o)),l);s=s.updateImmediateChild(o,a)}),Ra(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=_t(t.visibleWrites,e);return Ra(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function Mv(t,e,n,s,i){b(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=re(e,n);if(Pr(t.visibleWrites,r))return null;{const o=_t(t.visibleWrites,r);return Dr(o)?i.getChild(n):gn(o,i.getChild(n))}}function kv(t,e,n,s){const i=re(e,n),r=Jt(t.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(n)){const o=_t(t.visibleWrites,i);return gn(o,s.getNode().getImmediateChild(n))}else return null}function Lv(t,e){return Jt(t.visibleWrites,e)}function Fv(t,e,n,s,i,r,o){let l;const a=_t(t.visibleWrites,e),c=Jt(a,B());if(c!=null)l=c;else if(n!=null)l=gn(a,n);else return[];if(l=l.withIndex(o),!l.isEmpty()&&!l.isLeafNode()){const u=[],h=o.getCompare(),d=r?l.getReverseIteratorFrom(s,o):l.getIteratorFrom(s,o);let _=d.getNext();for(;_&&u.length<i;)h(_,s)!==0&&u.push(_),_=d.getNext();return u}else return[]}function Uv(){return{visibleWrites:Be.empty(),allWrites:[],lastWriteId:-1}}function zs(t,e,n,s){return Sh(t.writeTree,t.treePath,e,n,s)}function To(t,e){return Dv(t.writeTree,t.treePath,e)}function Aa(t,e,n,s){return Mv(t.writeTree,t.treePath,e,n,s)}function Ys(t,e){return Lv(t.writeTree,re(t.treePath,e))}function Bv(t,e,n,s,i,r){return Fv(t.writeTree,t.treePath,e,n,s,i,r)}function Ro(t,e,n){return kv(t.writeTree,t.treePath,e,n)}function Th(t,e){return Rh(re(t.treePath,e),t.writeTree)}function Rh(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hv{getCompleteChild(e){return null}getChildAfterChild(e,n,s){return null}}const Ah=new Hv;class Ao{constructor(e,n,s=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=s}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new bt(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Ro(this.writes_,e,s)}}getChildAfterChild(e,n,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Kt(this.viewCache_),r=Bv(this.writes_,i,n,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xs;function lb(t){b(!Xs,"__referenceConstructor has already been defined"),Xs=t}function ab(){return b(Xs,"Reference.ts has not been loaded"),Xs}let cb=1;class Ma{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Q(null),this.pendingWriteTree_=Uv(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Lh(t,e,n,s,i){return Rv(t.pendingWriteTree_,e,n,s,i),i?hs(t,new Gt(Ch(),e,n)):[]}function Ft(t,e,n=!1){const s=Av(t.pendingWriteTree_,e);if(Nv(t.pendingWriteTree_,e)){let r=new Q(null);return s.snap!=null?r=r.set(B(),!0):Ie(s.children,o=>{r=r.set(new G(o),!0)}),hs(t,new Ks(s.path,r,n))}else return[]}function us(t,e,n){return hs(t,new Gt(Io(),e,n))}function ub(t,e,n){const s=Q.fromObject(n);return hs(t,new ns(Io(),e,s))}function hb(t,e){return hs(t,new ts(Io(),e))}function fb(t,e,n){const s=Oo(t,n);if(s){const i=Po(s),r=i.path,o=i.queryId,l=ye(r,e),a=new ts(So(o),l);return Do(t,r,a)}else return[]}function Zs(t,e,n,s,i=!1){const r=e._path,o=t.syncPointTree_.get(r);let l=[];if(o&&(e._queryIdentifier==="default"||kh(o,e))){const a=ob(o,e,n,s);ib(o)&&(t.syncPointTree_=t.syncPointTree_.remove(r));const c=a.removed;if(l=a.events,!i){const u=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,h=t.syncPointTree_.findOnPath(r,(d,_)=>Ct(_));if(u&&!h){const d=t.syncPointTree_.subtree(r);if(!d.isEmpty()){const _=_b(d);for(let I=0;I<_.length;++I){const R=_[I],H=R.query,Y=$h(t,R);t.listenProvider_.startListening(Vn(H),ss(t,H),Y.hashFn,Y.onComplete)}}}!h&&c.length>0&&!s&&(u?t.listenProvider_.stopListening(Vn(e),null):c.forEach(d=>{const _=t.queryToTagMap.get(Ei(d));t.listenProvider_.stopListening(Vn(d),_)}))}gb(t,c)}return l}function Fh(t,e,n,s){const i=Oo(t,s);if(i!=null){const r=Po(i),o=r.path,l=r.queryId,a=ye(o,e),c=new Gt(So(l),a,n);return Do(t,o,c)}else return[]}function db(t,e,n,s){const i=Oo(t,s);if(i){const r=Po(i),o=r.path,l=r.queryId,a=ye(o,e),c=Q.fromObject(n),u=new ns(So(l),a,c);return Do(t,o,u)}else return[]}function Lr(t,e,n,s=!1){const i=e._path;let r=null,o=!1;t.syncPointTree_.foreachOnPath(i,(d,_)=>{const I=ye(d,i);r=r||gt(_,I),o=o||Ct(_)});let l=t.syncPointTree_.get(i);l?(o=o||Ct(l),r=r||gt(l,B())):(l=new Oh,t.syncPointTree_=t.syncPointTree_.set(i,l));let a;r!=null?a=!0:(a=!1,r=x.EMPTY_NODE,t.syncPointTree_.subtree(i).foreachChild((_,I)=>{const R=gt(I,B());R&&(r=r.updateImmediateChild(_,R))}));const c=kh(l,e);if(!c&&!e._queryParams.loadsAllData()){const d=Ei(e);b(!t.queryToTagMap.has(d),"View does not exist, but we have a tag");const _=mb();t.queryToTagMap.set(d,_),t.tagToQueryMap.set(_,d)}const u=Ci(t.pendingWriteTree_,i);let h=rb(l,e,n,u,r,a);if(!c&&!o&&!s){const d=Mh(l,e);h=h.concat(yb(t,e,d))}return h}function xo(t,e,n){const i=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,l)=>{const a=ye(o,e),c=gt(l,a);if(c)return c});return Sh(i,e,r,n,!0)}function pb(t,e){const n=e._path;let s=null;t.syncPointTree_.foreachOnPath(n,(c,u)=>{const h=ye(c,n);s=s||gt(u,h)});let i=t.syncPointTree_.get(n);i?s=s||gt(i,B()):(i=new Oh,t.syncPointTree_=t.syncPointTree_.set(n,i));const r=s!=null,o=r?new bt(s,!0,!1):null,l=Ci(t.pendingWriteTree_,e._path),a=Ph(i,e,l,r?o.getNode():x.EMPTY_NODE,r);return Xv(a)}function hs(t,e){return Uh(e,t.syncPointTree_,null,Ci(t.pendingWriteTree_,B()))}function Uh(t,e,n,s){if(L(t.path))return Bh(t,e,n,s);{const i=e.get(B());n==null&&i!=null&&(n=gt(i,B()));let r=[];const o=M(t.path),l=t.operationForChild(o),a=e.children.get(o);if(a&&l){const c=n?n.getImmediateChild(o):null,u=Th(s,o);r=r.concat(Uh(l,a,c,u))}return i&&(r=r.concat(No(i,t,s,n))),r}}function Bh(t,e,n,s){const i=e.get(B());n==null&&i!=null&&(n=gt(i,B()));let r=[];return e.children.inorderTraversal((o,l)=>{const a=n?n.getImmediateChild(o):null,c=Th(s,o),u=t.operationForChild(o);u&&(r=r.concat(Bh(u,l,a,c)))}),i&&(r=r.concat(No(i,t,s,n))),r}function $h(t,e){const n=e.query,s=ss(t,n);return{hashFn:()=>(Jv(e)||x.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?fb(t,n._path,s):hb(t,n._path);{const r=py(i,n);return Zs(t,n,null,r)}}}}function ss(t,e){const n=Ei(e);return t.queryToTagMap.get(n)}function Ei(t){return t._path.toString()+"$"+t._queryIdentifier}function Oo(t,e){return t.tagToQueryMap.get(e)}function Po(t){const e=t.indexOf("$");return b(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new G(t.substr(0,e))}}function Do(t,e,n){const s=t.syncPointTree_.get(e);b(s,"Missing sync point for query tag that we're tracking");const i=Ci(t.pendingWriteTree_,e);return No(s,n,i,null)}function _b(t){return t.fold((e,n,s)=>{if(n&&Ct(n))return[wi(n)];{let i=[];return n&&(i=Dh(n)),Ie(s,(r,o)=>{i=i.concat(o)}),i}})}function Vn(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(ab())(t._repo,t._path):t}function gb(t,e){for(let n=0;n<e.length;++n){const s=e[n];if(!s._queryParams.loadsAllData()){const i=Ei(s),r=t.queryToTagMap.get(i);t.queryToTagMap.delete(i),t.tagToQueryMap.delete(r)}}}function mb(){return cb++}function yb(t,e,n){const s=e._path,i=ss(t,e),r=$h(t,n),o=t.listenProvider_.startListening(Vn(e),i,r.hashFn,r.onComplete),l=t.syncPointTree_.subtree(s);if(i)b(!Ct(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((c,u,h)=>{if(!L(c)&&u&&Ct(u))return[wi(u).query];{let d=[];return u&&(d=d.concat(Dh(u).map(_=>_.query))),Ie(h,(_,I)=>{d=d.concat(I)}),d}});for(let c=0;c<a.length;++c){const u=a[c];t.listenProvider_.stopListening(Vn(u),ss(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fo{constructor(e="",n=null,s={children:{},childCount:0}){this.name=e,this.parent=n,this.node=s}}function Uo(t,e){let n=e instanceof G?e:new G(e),s=t,i=M(n);for(;i!==null;){const r=dn(s.node.children,i)||{children:{},childCount:0};s=new Fo(i,s,r),n=z(n),i=M(n)}return s}function Cn(t){return t.node.value}function Vh(t,e){t.node.value=e,Fr(t)}function Wh(t){return t.node.childCount>0}function Eb(t){return Cn(t)===void 0&&!Wh(t)}function Ii(t,e){Ie(t.node.children,(n,s)=>{e(new Fo(n,t,s))})}function jh(t,e,n,s){n&&!s&&e(t),Ii(t,i=>{jh(i,e,!0,s)}),n&&s&&e(t)}function Ib(t,e,n){let s=t.parent;for(;s!==null;){if(e(s))return!0;s=s.parent}return!1}function fs(t){return new G(t.parent===null?t.name:fs(t.parent)+"/"+t.name)}function Fr(t){t.parent!==null&&Sb(t.parent,t.name,t)}function Sb(t,e,n){const s=Eb(n),i=it(t.node.children,e);s&&i?(delete t.node.children[e],t.node.childCount--,Fr(t)):!s&&!i&&(t.node.children[e]=n.node,t.node.childCount++,Fr(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tb=/[\[\].#$\/\u0000-\u001F\u007F]/,Rb=/[\[\].#$\u0000-\u001F\u007F]/,sr=10*1024*1024,Gh=function(t){return typeof t=="string"&&t.length!==0&&!Tb.test(t)},Kh=function(t){return typeof t=="string"&&t.length!==0&&!Rb.test(t)},Ab=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Kh(t)},qh=function(t,e,n,s){s&&e===void 0||Bo(ro(t,"value"),e,n)},Bo=function(t,e,n){const s=n instanceof G?new qy(n,t):n;if(e===void 0)throw new Error(t+"contains undefined "+Pt(s));if(typeof e=="function")throw new Error(t+"contains a function "+Pt(s)+" with contents = "+e.toString());if(Wu(e))throw new Error(t+"contains "+e.toString()+" "+Pt(s));if(typeof e=="string"&&e.length>sr/3&&gi(e)>sr)throw new Error(t+"contains a string greater than "+sr+" utf8 bytes "+Pt(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(Ie(e,(o,l)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!Gh(o)))throw new Error(t+" contains an invalid key ("+o+") "+Pt(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);zy(s,o),Bo(t,l,s),Yy(s)}),i&&r)throw new Error(t+' contains ".value" child '+Pt(s)+" in addition to actual children.")}},zh=function(t,e,n,s){if(!Kh(n))throw new Error(ro(t,e)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Nb=function(t,e,n,s){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),zh(t,e,n)},Yh=function(t,e){if(M(e)===".info")throw new Error(t+" failed = Can't modify data under /.info/")},xb=function(t,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Gh(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!Ab(n))throw new Error(ro(t,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Db="repo_interrupt",Mb=25;class kb{constructor(e,n,s,i){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Ob,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Gs(),this.transactionQueueTree_=new Fo,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Lb(t,e,n){if(t.stats_=mo(t.repoInfo_),t.forceRestClient_||yy())t.server_=new js(t.repoInfo_,(s,i,r,o)=>{La(t,s,i,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>Fa(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{ie(n)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}t.persistentConnection_=new et(t.repoInfo_,e,(s,i,r,o)=>{La(t,s,i,r,o)},s=>{Fa(t,s)},s=>{Fb(t,s)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(s=>{t.server_.refreshAuthToken(s)}),t.appCheckProvider_.addTokenChangeListener(s=>{t.server_.refreshAppCheckToken(s.token)}),t.statsReporter_=Ey(t.repoInfo_,()=>new Cv(t.stats_,t.server_)),t.infoData_=new gv,t.infoSyncTree_=new Ma({startListening:(s,i,r,o)=>{let l=[];const a=t.infoData_.getNode(s._path);return a.isEmpty()||(l=us(t.infoSyncTree_,s._path,a),setTimeout(()=>{o("ok")},0)),l},stopListening:()=>{}}),Vo(t,"connected",!1),t.serverSyncTree_=new Ma({startListening:(s,i,r,o)=>(t.server_.listen(s,r,i,(l,a)=>{const c=o(l,a);Ye(t.eventQueue_,s._path,c)}),[]),stopListening:(s,i)=>{t.server_.unlisten(s,i)}})}function Xh(t){const n=t.infoData_.getNode(new G(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function Ho(t){return vb({timestamp:Xh(t)})}function La(t,e,n,s,i){t.dataUpdateCount++;const r=new G(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(i)if(s){const a=Us(n,c=>ue(c));o=db(t.serverSyncTree_,r,a,i)}else{const a=ue(n);o=Fh(t.serverSyncTree_,r,a,i)}else if(s){const a=Us(n,c=>ue(c));o=ub(t.serverSyncTree_,r,a)}else{const a=ue(n);o=us(t.serverSyncTree_,r,a)}let l=r;o.length>0&&(l=Ti(t,r)),Ye(t.eventQueue_,l,o)}function Fa(t,e){Vo(t,"connected",e),e===!1&&$b(t)}function Fb(t,e){Ie(e,(n,s)=>{Vo(t,n,s)})}function Vo(t,e,n){const s=new G("/.info/"+e),i=ue(n);t.infoData_.updateSnapshot(s,i);const r=us(t.infoSyncTree_,s,i);Ye(t.eventQueue_,s,r)}function Zh(t){return t.nextWriteId_++}function Ub(t,e,n){const s=pb(t.serverSyncTree_,e);return s!=null?Promise.resolve(s):t.server_.get(e).then(i=>{const r=ue(i).withIndex(e._queryParams.getIndex());Lr(t.serverSyncTree_,e,n,!0);let o;if(e._queryParams.loadsAllData())o=us(t.serverSyncTree_,e._path,r);else{const l=ss(t.serverSyncTree_,e);o=Fh(t.serverSyncTree_,e._path,r,l)}return Ye(t.eventQueue_,e._path,o),Zs(t.serverSyncTree_,e,n,null,!0),r},i=>(Si(t,"get for query "+ie(e)+" failed: "+i),Promise.reject(new Error(i))))}function Bb(t,e,n,s,i){Si(t,"set",{path:e.toString(),value:n,priority:s});const r=Ho(t),o=ue(n,s),l=xo(t.serverSyncTree_,e),a=Hh(o,l,r),c=Zh(t),u=Lh(t.serverSyncTree_,e,a,c,!0);$o(t.eventQueue_,u),t.server_.put(e.toString(),o.val(!0),(d,_)=>{const I=d==="ok";I||we("set at "+e+" failed: "+d);const R=Ft(t.serverSyncTree_,c,!I);Ye(t.eventQueue_,e,R),jb(t,i,d,_)});const h=rf(t,e);Ti(t,h),Ye(t.eventQueue_,h,[])}function $b(t){Si(t,"onDisconnectEvents");const e=Ho(t),n=Gs();Or(t.onDisconnect_,B(),(i,r)=>{const o=wb(i,r,t.serverSyncTree_,e);bh(n,i,o)});let s=[];Or(n,B(),(i,r)=>{s=s.concat(us(t.serverSyncTree_,i,r));const o=rf(t,i);Ti(t,o)}),t.onDisconnect_=Gs(),Ye(t.eventQueue_,B(),s)}function Hb(t,e,n){let s;M(e._path)===".info"?s=Lr(t.infoSyncTree_,e,n):s=Lr(t.serverSyncTree_,e,n),Qh(t.eventQueue_,e._path,s)}function Vb(t,e,n){let s;M(e._path)===".info"?s=Zs(t.infoSyncTree_,e,n):s=Zs(t.serverSyncTree_,e,n),Qh(t.eventQueue_,e._path,s)}function Wb(t){t.persistentConnection_&&t.persistentConnection_.interrupt(Db)}function Si(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),fe(n,...e)}function jb(t,e,n,s){e&&bn(()=>{if(n==="ok")e(null);else{const i=(n||"error").toUpperCase();let r=i;s&&(r+=": "+s);const o=new Error(r);o.code=i,e(o)}})}function ef(t,e,n){return xo(t.serverSyncTree_,e,n)||x.EMPTY_NODE}function Wo(t,e=t.transactionQueueTree_){if(e||Ri(t,e),Cn(e)){const n=nf(t,e);b(n.length>0,"Sending zero length transaction queue"),n.every(i=>i.status===0)&&Gb(t,fs(e),n)}else Wh(e)&&Ii(e,n=>{Wo(t,n)})}function Gb(t,e,n){const s=n.map(c=>c.currentWriteId),i=ef(t,e,s);let r=i;const o=i.hash();for(let c=0;c<n.length;c++){const u=n[c];b(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const h=ye(e,u.path);r=r.updateChild(h,u.currentOutputSnapshotRaw)}const l=r.val(!0),a=e;t.server_.put(a.toString(),l,c=>{Si(t,"transaction put response",{path:a.toString(),status:c});let u=[];if(c==="ok"){const h=[];for(let d=0;d<n.length;d++)n[d].status=2,u=u.concat(Ft(t.serverSyncTree_,n[d].currentWriteId)),n[d].onComplete&&h.push(()=>n[d].onComplete(null,!0,n[d].currentOutputSnapshotResolved)),n[d].unwatcher();Ri(t,Uo(t.transactionQueueTree_,e)),Wo(t,t.transactionQueueTree_),Ye(t.eventQueue_,e,u);for(let d=0;d<h.length;d++)bn(h[d])}else{if(c==="datastale")for(let h=0;h<n.length;h++)n[h].status===3?n[h].status=4:n[h].status=0;else{we("transaction at "+a.toString()+" failed: "+c);for(let h=0;h<n.length;h++)n[h].status=4,n[h].abortReason=c}Ti(t,e)}},o)}function Ti(t,e){const n=tf(t,e),s=fs(n),i=nf(t,n);return Kb(t,i,s),s}function Kb(t,e,n){if(e.length===0)return;const s=[];let i=[];const o=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const a=e[l],c=ye(n,a.path);let u=!1,h;if(b(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),a.status===4)u=!0,h=a.abortReason,i=i.concat(Ft(t.serverSyncTree_,a.currentWriteId,!0));else if(a.status===0)if(a.retryCount>=Mb)u=!0,h="maxretry",i=i.concat(Ft(t.serverSyncTree_,a.currentWriteId,!0));else{const d=ef(t,a.path,o);a.currentInputSnapshot=d;const _=e[l].update(d.val());if(_!==void 0){Bo("transaction failed: Data returned ",_,a.path);let I=ue(_);typeof _=="object"&&_!=null&&it(_,".priority")||(I=I.updatePriority(d.getPriority()));const H=a.currentWriteId,Y=Ho(t),ne=Hh(I,d,Y);a.currentOutputSnapshotRaw=I,a.currentOutputSnapshotResolved=ne,a.currentWriteId=Zh(t),o.splice(o.indexOf(H),1),i=i.concat(Lh(t.serverSyncTree_,a.path,ne,a.currentWriteId,a.applyLocally)),i=i.concat(Ft(t.serverSyncTree_,H,!0))}else u=!0,h="nodata",i=i.concat(Ft(t.serverSyncTree_,a.currentWriteId,!0))}Ye(t.eventQueue_,n,i),i=[],u&&(e[l].status=2,function(d){setTimeout(d,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(h==="nodata"?s.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):s.push(()=>e[l].onComplete(new Error(h),!1,null))))}Ri(t,t.transactionQueueTree_);for(let l=0;l<s.length;l++)bn(s[l]);Wo(t,t.transactionQueueTree_)}function tf(t,e){let n,s=t.transactionQueueTree_;for(n=M(e);n!==null&&Cn(s)===void 0;)s=Uo(s,n),e=z(e),n=M(e);return s}function nf(t,e){const n=[];return sf(t,e,n),n.sort((s,i)=>s.order-i.order),n}function sf(t,e,n){const s=Cn(e);if(s)for(let i=0;i<s.length;i++)n.push(s[i]);Ii(e,i=>{sf(t,i,n)})}function Ri(t,e){const n=Cn(e);if(n){let s=0;for(let i=0;i<n.length;i++)n[i].status!==2&&(n[s]=n[i],s++);n.length=s,Vh(e,n.length>0?n:void 0)}Ii(e,s=>{Ri(t,s)})}function rf(t,e){const n=fs(tf(t,e)),s=Uo(t.transactionQueueTree_,e);return Ib(s,i=>{ir(t,i)}),ir(t,s),jh(s,i=>{ir(t,i)}),n}function ir(t,e){const n=Cn(e);if(n){const s=[];let i=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(b(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(b(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(Ft(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&s.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?Vh(e,void 0):n.length=r+1,Ye(t.eventQueue_,fs(e),i);for(let o=0;o<s.length;o++)bn(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jo{constructor(e,n,s,i){this._repo=e,this._path=n,this._queryParams=s,this._orderByCalled=i}get key(){return L(this._path)?null:uh(this._path)}get ref(){return new rt(this._repo,this._path)}get _queryIdentifier(){const e=Ea(this._queryParams),n=_o(e);return n==="{}"?"default":n}get _queryObject(){return Ea(this._queryParams)}isEqual(e){if(e=It(e),!(e instanceof jo))return!1;const n=this._repo===e._repo,s=vo(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+Ky(this._path)}}class rt extends jo{constructor(e,n){super(e,n,new Eo,!1)}get parent(){const e=fh(this._path);return e===null?null:new rt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class is{constructor(e,n,s){this._node=e,this.ref=n,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new G(e),s=rs(this.ref,e);return new is(this._node.getChild(n),s,te)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new is(i,rs(this.ref,s),te)))}hasChild(e){const n=new G(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Go(t,e){return t=It(t),t._checkNotDeleted("ref"),e!==void 0?rs(t._root,e):t._root}function rs(t,e){return t=It(t),M(t._path)===null?Nb("child","path",e):zh("child","path",e),new rt(t._repo,re(t._path,e))}function Zb(t,e){t=It(t),Yh("push",t._path),qh("push",e,t._path,!0);const n=Xh(t._repo),s=Qb(n),i=rs(t,s),r=rs(t,s);let o;return o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function rr(t,e){t=It(t),Yh("set",t._path),qh("set",e,t._path,!1);const n=new pi;return Bb(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function eC(t){t=It(t);const e=new of(()=>{}),n=new Ai(e);return Ub(t._repo,t,n).then(s=>new is(s,new rt(t._repo,t._path),t._queryParams.getIndex()))}class Ai{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const s=n._queryParams.getIndex();return new Jb("value",this,new is(e.snapshotNode,new rt(n._repo,n._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Xb(this,e,n):null}matches(e){return e instanceof Ai?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function tC(t,e,n,s,i){const r=new of(n,void 0),o=new Ai(r);return Hb(t._repo,t,o),()=>Vb(t._repo,t,o)}function $a(t,e,n,s){return tC(t,"value",e)}nb(rt);lb(rt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hC(t){sy(Rg),yt(new tt("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return rC(s,i,r,n)},"PUBLIC").setMultipleInstances(!0)),ze(oa,la,t),ze(oa,la,"esm2017")}et.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};et.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};hC();const fC={apiKey:"AIzaSyBGKFlZcgiuKJMCAmSU1F2L8-mpRtWyGCk",authDomain:"bbpag-e60d8.firebaseapp.com",projectId:"bbpag-e60d8",storageBucket:"bbpag-e60d8.appspot.com",messagingSenderId:"685339319716",appId:"1:685339319716:web:5e0c10926798b5f5e47531",measurementId:"G-XVKYW0BGTL",databaseURL:"https://bbpag-e60d8-default-rtdb.asia-southeast1.firebasedatabase.app/"},dC=_u(fC);let Ko=cC(dC),Ha=Go(Ko,"data"),Va=Go(Ko,"count"),Wa=Go(Ko,"view");const lt=i_({state(){return{data:{},count:0,view:0}},mutations:{renewData(t,e){t.data=e},renewCount(t,e){t.count=e}},actions:{onValueData(t){$a(Ha,e=>{let n=e.val();t.commit("renewData",n)})},onValueCount(t,e){$a(Va,n=>{let s=n.val();t.commit("renewCount",s)})},async addViewer(t,e){let n;await eC(Wa).then(r=>{n=r.val()});let s=new Date,i={count:++n.count,time:String(s)};rr(Wa,i)},sent(t,e){let n=Zb(Ha);rr(n,e)},setNewCount(t,e){rr(Va,e)}}}),pC=(t,e)=>{const n=t.__vccOpts||t;for(const[s,i]of e)n[s]=i;return n},_C={class:"wrap"},gC={class:"cntWrap"},mC={class:"date"},yC={class:"input-group mb-3"},vC=["placeholder"],bC={class:"input-group mb-3"},CC=["placeholder"],wC={__name:"App",setup(t){let e=Sn(lt.state.data),n=Sn(""),s=Sn(""),i=Sn("誰"),r=Sn("說什麼");an(()=>lt.state.data,c=>{e.value=c}),Tc(async()=>{lt.dispatch("onValueData"),lt.dispatch("onValueCount"),await lt.dispatch("addViewer")});async function o(){let c=Object.values(e.value),u;return c.some(h=>(u=h.count,h.name==s.value))?u:await l()}async function l(){let c=lt.state.count+160;return await lt.dispatch("setNewCount",c),c}async function a(){if(!s.value)i.value="要說你是誰";else if(!n.value)r.value="你沒說你想說什麼";else{i.value="誰",r.value="說什麼";let c=new Date;lt.dispatch("sent",{name:s.value,cnt:n.value,time:`${c.getMonth()+1}-${c.getDate()}-${c.getHours()}`,count:await o()}),n.value=""}}return(c,u)=>(Bi(),$i("div",_C,[Ne("div",gC,[(Bi(!0),$i(Ge,null,Ed(xt(e),h=>(Bi(),$i("div",{style:si({backgroundColor:`rgb(${h.count%255}, 0, 0, 0.15)`}),class:ii(["cnt",h.name==xt(s)?"now":""])},[Ne("div",null,[Ne("span",null,Di(h.name),1),Hc(" 說:"),Ne("div",null,Di(h.cnt),1)]),Ne("div",mC,Di(h.time),1)],6))),256))]),Ne("div",yC,[hl(Ne("textarea",{onKeyup:Rp(a,["enter"]),"onUpdate:modelValue":u[0]||(u[0]=h=>pe(s)?s.value=h:s=h),type:"text",class:"form-control",placeholder:xt(i),"aria-label":"Example text with button addon","aria-describedby":"button-addon1"},null,40,vC),[[Ml,xt(s)]])]),Ne("div",bC,[hl(Ne("textarea",{"onUpdate:modelValue":u[1]||(u[1]=h=>pe(n)?n.value=h:n=h),type:"text",class:"form-control",placeholder:xt(r),"aria-label":"Recipient's username","aria-describedby":"button-addon2"},null,8,CC),[[Ml,xt(n)]]),Ne("button",{onClick:a,class:"btn btn-outline-secondary",type:"button",id:"button-addon2"},"send")])]))}},EC=pC(wC,[["__scopeId","data-v-c1686a4d"]]);let IC=xp(EC);IC.mount("#app");
