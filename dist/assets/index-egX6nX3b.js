 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rg=wg;function _u(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:Er,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw pt.create("bad-app-name",{appName:String(i)});if(n||(n=ou()),!n)throw pt.create("no-options");const r=Bs.get(i);if(r){if(vr(n,r.options)&&vr(s,r.config))return r;throw pt.create("duplicate-app",{appName:i})}const o=new k_(i);for(const a of Ir.values())o.addComponent(a);const l=new Tg(n,s,o);return Bs.set(i,l),l}function Ag(t=Er){const e=Bs.get(t);if(!e&&t===Er&&ou())return _u();if(!e)throw pt.create("no-app",{appName:t});return e}function ze(t,e,n){var s;let i=(s=Eg[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const l=[`Unable to register library "${i}" with version "${e}":`];r&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),$t.warn(l.join(" "));return}yt(new tt(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qg=/^[cdef][\w-]{21}$/,Sr="";function Jg(){try{const t=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(t),t[0]=112+t[0]%16;const n=Xg(t);return Qg.test(n)?n:Sr}catch{return Sr}}function Xg(t){return Yg(t).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hv{getCompleteChild(e){return null}getChildAfterChild(e,n,s){return null}}const Ah=new Hv;class Ro{constructor(e,n,s=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=s}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new bt(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return To(this.writes_,e,s)}}getChildAfterChild(e,n,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Gt(this.viewCache_),r=Bv(this.writes_,i,n,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
